...
\restrict C19ePaVfaDtKHiyejELe4uTqh1zSSl6Ym6xT76KxunYZCzS80yZREecXfXn9Bs7
...
--
-- Name: COLUMN logs.task_id; Type: COMMENT; Schema: public; Owner: tokensapi
--

COMMENT ON COLUMN public.logs.task_id IS '异步任务ID，非空时表示异步任务，用于轮询状态跟踪';


--
-- Name: COLUMN logs.action_type; Type: COMMENT; Schema: public; Owner: tokensapi
--

COMMENT ON COLUMN public.logs.action_type IS '任务类型：聊天、图片、视频等，用于精准筛选和显示';
...
CREATE TABLE public.user_levels (
    ...
    allow_view_log_details integer DEFAULT 1 NOT NULL
);
...
--
-- Name: COLUMN user_levels.allow_view_log_details; Type: COMMENT; Schema: public; Owner: tokensapi
--

COMMENT ON COLUMN public.user_levels.allow_view_log_details IS '是否允许查看日志详情，1-允许，0-不允许';
...
CREATE TABLE public.users (
    ...
    wechat_name text,
    google_name text,
    referral_history text DEFAULT ''::text,
...
--
-- Name: COLUMN users.referral_history; Type: COMMENT; Schema: public; Owner: tokensapi
--

COMMENT ON COLUMN public.users.referral_history IS '关联流转记录';
...
12	464fdb02-5e2f-4979-89d1-77da502682f6	sk-9dcae6dfa0ab1cc43ddbfba50c38e93d2ad552c711d13318	default	-1	7.478958	[]		\N	0	0	\N	1	\N	other	\N	2026-04-28 13:05:56.900105+00	2026-04-28 15:39:51.949365+00	577578
...
13	a6fde4b2-5728-4fbb-b14c-de4934cb66da	sk-ec2a9ad49fa3e7afdc48072674b413af592a33c016c44eef	default	-1	0.5	[]		\N	0	0	\N	1	\N	other	\N	2026-04-28 17:38:04.176421+00	2026-04-28 19:18:38.825623+00	716864
...
19	可灵视频官方计费	duration	0	0	0	0.1	kling_video	[]	{"mode_multipliers":{"std":1.0,"pro":1.33,"4k":2.0},"sound_multipliers":{"off":1.0,"on":1.5}}	1	\N	other	\N	2026-04-30 16:59:43.90298+00	2026-04-30 16:59:43.90298+00	1	0
\.
...
3	SC-api	SC-api	https://api.apimart.ai/v1/images/generations	sk-UxNnAGVzqb1Fsbzq8DqdIT9yNfl7IBpIDs8hov4QHp8iJAkU	SC-api	2026-04-28 11:59:30.489848+00	2026-04-28 11:59:30.489848+00
\.
...
4	SC-api	custom			["gpt-image-2","gptimage2vip","gpt-image"]	{}	0	1	1	\N	0	-1	0	null	[]	4911	3	2026-04-28 11:59:54.121106+00	2026-04-28 17:44:05.387082+00	\N	\N
1	给主站使用	custom			["doubao-seedream-4-0-250828"]	{}	0	1	1	\N	0	-1	3.850000000000001	null	[]	1239	1	2026-04-25 08:14:46.725282+00	2026-04-28 18:27:45.979472+00	\N	\N
2	sd4.0	custom			["doubao-seedream-4-0-250828"]	{}	0	1	1	\N	0	-1	0.25	null	[]	5708	\N	2026-04-27 10:05:52.034316+00	2026-04-28 19:18:38.825623+00	1	\N
\.
...
19	可灵 视频生成 (文/图/多图)	kling	视频	{"mode":"transform","target_type":"kling","path_rewrite":{"old":"/v1/video/generations","new":"/v1/videos/text2video"},"auth_type":"bearer"}	将标准视频生成请求转发到可灵官方 API，系统根据请求体自动分发到 text2video/image2video/multi-image2video	1	1	\N	other	\N	2026-04-30 16:59:43.899245+00	2026-04-30 16:59:43.899245+00
20	可灵 图片生成	kling	图片	{"mode":"transform","target_type":"kling","path_rewrite":{"old":"/v1/images/generations","new":"/v1/images/generations"},"auth_type":"bearer"}	将标准图片生成请求转发到可灵官方 API，含多图参考自动分发	1	1	\N	other	\N	2026-04-30 16:59:43.899245+00	2026-04-30 16:59:43.899245+00
21	可灵 Omni 视频 (kling-v3-omni/video-o1)	kling	视频	{"mode":"transform","target_type":"kling","path_rewrite":{"old":"/v1/video/generations","new":"/v1/videos/omni-video"},"auth_type":"bearer"}	将视频生成请求转发到可灵 Omni 视频端点	1	1	\N	other	\N	2026-04-30 16:59:43.899245+00	2026-04-30 16:59:43.899245+00
22	可灵 Omni 图片 (kling-v3-omni/image-o1)	kling	图片	{"mode":"transform","target_type":"kling","path_rewrite":{"old":"/v1/images/generations","new":"/v1/images/omni-image"},"auth_type":"bearer"}	将图片生成请求转发到可灵 Omni 图片端点	1	1	\N	other	\N	2026-04-30 16:59:43.899245+00	2026-04-30 16:59:43.899245+00
...
COPY public.logs (id, user_id, channel_id, token_id, model, prompt_tokens, completion_tokens, cost, latency_ms, status_code, endpoint, error_message, upstream_url, request_content, response_content, upstream_req_content, is_stream, billing_detail, created_at, cached_tokens, task_id, action_type) FROM stdin;
11	937afe47-9cd7-4ee8-9a22-fe4bd7720b34	0	0	doubao-seedream-4-0-250828	0	0	0	0	404	/v1/video/generations	No available channels found for model doubao-seedream-4-0-250828		\N	\N	\N	0		2026-04-25 08:14:19.199996+00	0		视频
12	937afe47-9cd7-4ee8-9a22-fe4bd7720b34	1	1	doubao-seedream-4-0-250828	0	0	0	10207	200	/v1/video/generations	\N	https://ark.cn-beijing.volces.com/api/v3/images/generations	{"camera_fixed":false,"duration":5,"generate_audio":true,"model":"doubao-seedream-4-0-250828","prompt":"一个美女在咖啡店喝咖啡","ratio":"16:9","resolution":"720p","return_last_frame":false,"seed":-1,"watermark":false}	{"model":"doubao-seedream-4-0-250828","created":1777104900,"data":[{"url":"https://ark-content-generation-v2-cn-beijing.tos-cn-beijing.volces.com/doubao-seedream-4-0/021777104892450546c150dd91466c4968e4bb2bdb9d5d2ce8b56_0.jpeg?X-Tos-Algorithm=TOS4-HMAC-SHA256&X-Tos-Credential=AKLTYWJkZTExNjA1ZDUyNDc3YzhjNTM5OGIyNjBhNDcyOTQ%2F20260425%2Fcn-beijing%2Ftos%2Frequest&X-Tos-Date=20260425T081500Z&X-Tos-Expires=86400&X-Tos-Signature=8d0c9da778056d1341bbd30a28cc8acc971dd64b0cd912d949b8f8271db54a6e&X-Tos-SignedHeaders=host","size":"2048x2048"}],"usage":{"generated_images":1,"output_tokens":16384,"total_tokens":16384}}\n	{"camera_fixed":false,"duration":5,"generate_audio":true,"model":"doubao-seedream-4-0-250828","prompt":"一个美女在咖啡店喝咖啡","ratio":"16:9","resolution":"720p","return_last_frame":false,"seed":-1,"watermark":false}	0	异步任务处理中(冻结)	2026-04-25 08:15:01.006143+00	0		视频
13	937afe47-9cd7-4ee8-9a22-fe4bd7720b34	0	0	doubao-seedance-1-5-pro-251215	0	0	0	0	404	/v1/video/generations	No available channels found for model doubao-seedance-1-5-pro-251215		\N	\N	\N	0		2026-04-25 08:17:01.985529+00	0		视频
1	unknown	0	0	unknown	0	0	0	0	401	/api/v1/announcements/public	Invalid API Key		\N	\N	\N	0		2026-04-25 03:02:57.245712+00	0		其它
2	unknown	0	0	unknown	0	0	0	0	401	/api/v1/announcements/public	Missing Authorization Header		\N	\N	\N	0		2026-04-25 03:02:57.429522+00	0		其它
3	unknown	0	0	unknown	0	0	0	0	401	/api/v1/announcements/public	Missing Authorization Header		\N	\N	\N	0		2026-04-25 03:02:57.453087+00	0		其它
4	unknown	0	0	unknown	0	0	0	0	401	/api/v1/announcements/public	Missing Authorization Header		\N	\N	\N	0		2026-04-25 03:02:57.473542+00	0		其它
5	unknown	0	0	unknown	0	0	0	0	401	/api/v1/announcements/public	Missing Authorization Header		\N	\N	\N	0		2026-04-25 03:02:57.495512+00	0		其它
6	unknown	0	0	unknown	0	0	0	0	401	/api/v1/announcements/public	Missing Authorization Header		\N	\N	\N	0		2026-04-25 03:02:57.519023+00	0		其它
7	unknown	0	0	unknown	0	0	0	0	401	/api/v1/announcements/public	Missing Authorization Header		\N	\N	\N	0		2026-04-25 03:02:57.54895+00	0		其它
8	unknown	0	0	unknown	0	0	0	0	401	/api/v1/team-marketing/allowed-levels	Invalid API Key		\N	\N	\N	0		2026-04-25 04:33:36.412385+00	0		其它
9	unknown	0	0	unknown	0	0	0	0	401	/api/v1/team-marketing/allowed-member-levels	Invalid API Key		\N	\N	\N	0		2026-04-25 04:44:21.676168+00	0		其它
10	unknown	0	0	unknown	0	0	0	0	401	/api/v1/team-marketing/allowed-member-levels	Invalid API Key		\N	\N	\N	0		2026-04-25 04:44:21.687953+00	0		其它
67	a6fde4b2-5728-4fbb-b14c-de4934cb66da	4	13	gpt-image-2	0	0	0	3772	200	/v1/images/generations	\N	https://api.apimart.ai/v1/images/generations	{"background":"auto","model":"gpt-image-2","n":1,"output_format":"png","prompt":"一个亚洲美女在咖啡店喝咖啡穿着包臀连衣裙吊带","quality":"auto","size":"1024x1024"}	{"code":200,"data":[{"status":"submitted","task_id":"task_01KQAK2E1V9B7GKQA9DE353V0S"}]}	{"background":"auto","model":"gpt-image-2","n":1,"output_format":"png","prompt":"一个亚洲美女在咖啡店喝咖啡穿着包臀连衣裙吊带","quality":"auto","size":"1024x1024"}	0	异步任务处理中(冻结)	2026-04-28 17:44:26.29345+00	0		图片
23	unknown	0	0	unknown	0	0	0	0	401	/	Missing Authorization Header		\N	\N	\N	0		2026-04-25 12:10:41.729386+00	0		其它
24	unknown	0	0	unknown	0	0	0	0	401	/	Missing Authorization Header		\N	\N	\N	0		2026-04-25 12:25:11.685915+00	0		其它
25	unknown	0	0	unknown	0	0	0	0	401	/	Missing Authorization Header		\N	\N	\N	0		2026-04-25 12:31:21.834306+00	0		其它
26	unknown	0	0	unknown	0	0	0	0	401	/	Missing Authorization Header		\N	\N	\N	0		2026-04-25 12:31:28.835283+00	0		其它
27	unknown	0	0	unknown	0	0	0	0	401	/	Missing Authorization Header		\N	\N	\N	0		2026-04-25 12:49:55.72659+00	0		其它
31	7fc96805-e78e-431d-8b6d-8a54fd18ae2a	1	6	doubao-seedream-4-0-250828	0	4096	0.2	5982	200	/v1/images/generations	\N	https://ark.cn-beijing.volces.com/api/v3/images/generations	{"guidance_scale":7,"model":"doubao-seedream-4-0-250828","n":1,"prompt":"一个亚洲美女穿着包臀短裙在照镜子","ratio":"1:1","size":"1024x1024","watermark":false}	{"model":"doubao-seedream-4-0-250828","created":1777139506,"data":[{"url":"https://ark-content-generation-v2-cn-beijing.tos-cn-beijing.volces.com/doubao-seedream-4-0/021777139501060e3fc3002f37f70960f01c9f37bff6e8235c533_0.jpeg?X-Tos-Algorithm=TOS4-HMAC-SHA256&X-Tos-Credential=AKLTYWJkZTExNjA1ZDUyNDc3YzhjNTM5OGIyNjBhNDcyOTQ%2F20260425%2Fcn-beijing%2Ftos%2Frequest&X-Tos-Date=20260425T175146Z&X-Tos-Expires=86400&X-Tos-Signature=916091f629eb37714df8abb339846190dbddfe88a41f11c4e2ae2e8eeac1f35d&X-Tos-SignedHeaders=host","size":"1024x1024"}],"usage":{"generated_images":1,"output_tokens":4096,"total_tokens":4096}}\n	{"guidance_scale":7,"model":"doubao-seedream-4-0-250828","prompt":"一个亚洲美女穿着包臀短裙在照镜子","ratio":"1:1","size":"1024x1024","watermark":false}	0	固定按次计费 -> (1量 * 0.2单价 * 1.00倍率) | 等级折扣	2026-04-25 17:51:46.783952+00	0		图片
37	unknown	0	0	unknown	0	0	0	0	401	/api/auth/login	Missing Authorization Header		\N	\N	\N	0		2026-04-26 17:36:19.508833+00	0		其它
36	f41d8242-87f6-4d04-9404-2e44ae001f11	1	8	doubao-seedream-4-0-250828	0	4096	0.2	52009	200	/v1/images/generations	\N	https://ark.cn-beijing.volces.com/api/v3/images/generations	{"guidance_scale":7,"image":""base64数据"","image_url":""base64数据"","model":"doubao-seedream-4-0-250828","n":1,"prompt":"吧图二的衣服换到图一的模特身上","ratio":"1:1","size":"1024x1024","watermark":false}	{"model":"doubao-seedream-4-0-250828","created":1777160781,"data":[{"url":"https://ark-content-generation-v2-cn-beijing.tos-cn-beijing.volces.com/doubao-seedream-4-0/0217771607336225de161b16d50149cbf4122a430bab0f06f709d_0.jpeg?X-Tos-Algorithm=TOS4-HMAC-SHA256&X-Tos-Credential=AKLTYWJkZTExNjA1ZDUyNDc3YzhjNTM5OGIyNjBhNDcyOTQ%2F20260425%2Fcn-beijing%2Ftos%2Frequest&X-Tos-Date=20260425T234621Z&X-Tos-Expires=86400&X-Tos-Signature=05ecfb603b78432f2b272cac6dc5e5849680c89bd29f70705dafec7030f77aa3&X-Tos-SignedHeaders=host","size":"1024x1024"}],"usage":{"generated_images":1,"output_tokens":4096,"total_tokens":4096}}\n	{"guidance_scale":7,"image":""base64数据"","image_url":""base64数据"","model":"doubao-seedream-4-0-250828","prompt":"吧图二的衣服换到图一的模特身上","ratio":"1:1","size":"1024x1024","watermark":false}	0	固定按次计费 -> (1量 * 0.2单价 * 1.00倍率) | 等级折扣	2026-04-25 23:46:22.132953+00	0		图片
46	unknown	0	0	unknown	0	0	0	0	401	/api/v1/contents/generations/tasks	Invalid API Key		\N	\N	\N	0		2026-04-28 09:24:57.328393+00	0		视频
47	unknown	0	0	unknown	0	0	0	0	401	/api/v3/contents/generations/tasks	Invalid API Key		\N	\N	\N	0		2026-04-28 09:25:09.868044+00	0		视频
48	937afe47-9cd7-4ee8-9a22-fe4bd7720b34	0	0	seedance-2.0-fast	0	0	0	0	404	/api/v3/contents/generations/tasks	No available channels found for model seedance-2.0-fast		\N	\N	\N	0		2026-04-28 09:25:58.79642+00	0		视频
49	937afe47-9cd7-4ee8-9a22-fe4bd7720b34	2	1	doubao-seedream-4-0-250828	0	0	0	1783	401	/api/v3/contents/generations/tasks	{"error":{"code":"AuthenticationError","message":"The API key format is incorrect. Request id: 02177736837798789a6ab5dfd15f12fdf9b1912203a3c65694f35","param":"","type":"Unauthorized"}}	/api/v3/contents/generations/tasks	{"model":"doubao-seedream-4-0-250828","prompt":"test"}	\N	{"model":"doubao-seedream-4-0-250828","prompt":"test","resolution":"720p"}	0	\N	2026-04-28 09:26:18.032783+00	0		视频
38	unknown	0	0	unknown	0	0	0	0	401	/api/model-providers	Invalid Bearer Token Format		\N	\N	\N	0		2026-04-26 17:36:19.52345+00	0		其它
39	unknown	0	0	unknown	0	0	0	0	401	/api/auth/login	Missing Authorization Header		\N	\N	\N	0		2026-04-26 17:41:41.276649+00	0		其它
40	unknown	0	0	unknown	0	0	0	0	401	/api/admin/model-classifications	Invalid Bearer Token Format		\N	\N	\N	0		2026-04-26 17:41:41.288305+00	0		其它
41	unknown	0	0	unknown	0	0	0	0	401	/api/v1/admin/login	Missing Authorization Header		\N	\N	\N	0		2026-04-28 07:52:26.549086+00	0		其它
42	unknown	0	0	unknown	0	0	0	0	401	/api/v1/login	Missing Authorization Header		\N	\N	\N	0		2026-04-28 07:52:26.594825+00	0		其它
43	unknown	0	0	unknown	0	0	0	0	401	/api/v1/admin/login	Missing Authorization Header		\N	\N	\N	0		2026-04-28 07:52:59.168355+00	0		其它
44	unknown	0	0	unknown	0	0	0	0	401	/api/v1/admin/login	Missing Authorization Header		\N	\N	\N	0		2026-04-28 07:52:59.211927+00	0		其它
45	unknown	0	0	unknown	0	0	0	0	401	/api/v1/admin/login	Missing Authorization Header		\N	\N	\N	0		2026-04-28 07:53:16.315725+00	0		其它
52	8321514a-13f1-4fc3-9384-7223919c7d18	4	0	gemini-3.1-flash-image-preview-official	0	0	0	1315	200	https://api.apimart.ai/v1/images/generations	\N	https://api.apimart.ai/v1/images/generations	\N	\N	\N	0		2026-04-28 12:00:00.871361+00	0		图片
53	8321514a-13f1-4fc3-9384-7223919c7d18	4	0	gemini-3.1-flash-image-preview	0	0	0	233	200	https://api.apimart.ai/v1/images/generations	\N	https://api.apimart.ai/v1/images/generations	\N	\N	\N	0		2026-04-28 12:00:03.338281+00	0		图片
54	8321514a-13f1-4fc3-9384-7223919c7d18	4	0	gemini-3-pro-image-preview-official	0	0	0	148	200	https://api.apimart.ai/v1/images/generations	\N	https://api.apimart.ai/v1/images/generations	\N	\N	\N	0		2026-04-28 12:00:03.625975+00	0		图片
55	8321514a-13f1-4fc3-9384-7223919c7d18	4	0	gemini-3-pro-image-preview	0	0	0	146	200	https://api.apimart.ai/v1/images/generations	\N	https://api.apimart.ai/v1/images/generations	\N	\N	\N	0		2026-04-28 12:00:04.0967+00	0		图片
56	8321514a-13f1-4fc3-9384-7223919c7d18	4	0	gpt-image-2	0	0	0	151	200	https://api.apimart.ai/v1/images/generations	\N	https://api.apimart.ai/v1/images/generations	\N	\N	\N	0		2026-04-28 12:00:04.801817+00	0		图片
72	a6fde4b2-5728-4fbb-b14c-de4934cb66da	4	13	gpt-image-2	0	0	0	380	200	/v1/images/generations	\N	https://api.apimart.ai/v1/images/generations	{"background":"auto","model":"gpt-image-2","n":1,"output_format":"png","prompt":"长发大波浪一个亚洲美女在咖啡店喝咖啡","quality":"auto","size":"1024x1024"}	{"code":200,"data":[{"status":"submitted","task_id":"task_01KQAM87E50R13E102EWXZA3GD"}]}	{"background":"auto","model":"gpt-image-2","n":1,"output_format":"png","prompt":"长发大波浪一个亚洲美女在咖啡店喝咖啡","quality":"auto","size":"1024x1024"}	0	异步任务处理中(冻结)	2026-04-28 18:05:04.756776+00	0		图片
68	a6fde4b2-5728-4fbb-b14c-de4934cb66da	4	13	gptimage2vip	0	0	0	308	503	/v1/images/generations	{"error":{"code":"model_not_found","message":"Please wait and try again later. Thank you for your patience! (request id: 2026042901443195046965FQVw1Xup)","type":"apimart_error"}}	https://api.apimart.ai/v1/images/generations	\N	{"error":{"code":"model_not_found","message":"Please wait and try again later. Thank you for your patience! (request id: 2026042901443195046965FQVw1Xup)","type":"apimart_error"}}	\N	0	\N	2026-04-28 17:44:31.439179+00	0		图片
...
69	a6fde4b2-5728-4fbb-b14c-de4934cb66da	4	13	gpt-image	0	0	0	294	503	/v1/images/generations	{"error":{"code":"model_not_found","message":"Please wait and try again later. Thank you for your patience! (request id: 20260429014435456282365dQEiwGjG)","type":"apimart_error"}}	https://api.apimart.ai/v1/images/generations	\N	{"error":{"code":"model_not_found","message":"Please wait and try again later. Thank you for your patience! (request id: 20260429014435456282365dQEiwGjG)","type":"apimart_error"}}	\N	0	\N	2026-04-28 17:44:35.795212+00	0		图片
70	a6fde4b2-5728-4fbb-b14c-de4934cb66da	4	13	gpt-image-2	0	0	0	1806	200	/v1/images/generations	\N	https://api.apimart.ai/v1/images/generations	{"background":"auto","model":"gpt-image-2","n":1,"output_format":"png","prompt":"一个亚洲美女在咖啡店喝咖啡","quality":"auto","size":"1024x1024"}	{"code":200,"data":[{"status":"submitted","task_id":"task_01KQAK8J46B4CKAZ600E6YA2S6"}]}	{"background":"auto","model":"gpt-image-2","n":1,"output_format":"png","prompt":"一个亚洲美女在咖啡店喝咖啡","quality":"auto","size":"1024x1024"}	0	异步任务处理中(冻结)	2026-04-28 17:47:47.085376+00	0		图片
73	a6fde4b2-5728-4fbb-b14c-de4934cb66da	1	13	doubao-seedream-4-0-250828	0	4096	0.25	11486	200	/v1/images/generations	\N	https://ark.cn-beijing.volces.com/api/v3/images/generations	{"guidance_scale":7,"model":"doubao-seedream-4-0-250828","n":1,"prompt":"一个亚洲美女在咖啡店喝咖啡穿着包臀连衣裙吊带","ratio":"1:1","size":"1024x1024","watermark":false}	{"model":"doubao-seedream-4-0-250828","created":1777400865,"data":[{"url":"https://ark-content-generation-v2-cn-beijing.tos-cn-beijing.volces.com/doubao-seedream-4-0/0217774008587073b744fffeb88c418a31726ba8a0f731c37a141_0.jpeg?X-Tos-Algorithm=TOS4-HMAC-SHA256&X-Tos-Credential=AKLTYWJkZTExNjA1ZDUyNDc3YzhjNTM5OGIyNjBhNDcyOTQ%2F20260428%2Fcn-beijing%2Ftos%2Frequest&X-Tos-Date=20260428T182745Z&X-Tos-Expires=86400&X-Tos-Signature=f8cd7e29951188aac263b4449e79299c197848893643f9ece647935b37093886&X-Tos-SignedHeaders=host","size":"1024x1024"}],"usage":{"generated_images":1,"output_tokens":4096,"total_tokens":4096}}\n	{"guidance_scale":7,"model":"doubao-seedream-4-0-250828","prompt":"一个亚洲美女在咖啡店喝咖啡穿着包臀连衣裙吊带","ratio":"1:1","size":"1024x1024","watermark":false}	0	按张返回计费 -> (1量 * 0.250000单价 * 1.00倍率) | 等级折扣	2026-04-28 18:27:45.979472+00	0		图片
74	a6fde4b2-5728-4fbb-b14c-de4934cb66da	4	13	gpt-image-2	0	0	0	296	503	/v1/images/generations	<html>\r\n<head><title>503 Service Temporarily Unavailable</title></head>\r\n<body>\r\n<center><h1>503 Service Temporarily Unavailable</h1></center>\r\n<hr><center>nginx</center>\r\n</body>\r\n</html>\r\n	https://api.apimart.ai/v1/images/generations	{"background":"auto","model":"gpt-image-2","n":1,"output_format":"png","prompt":"一个在躺在酒店穿着黑丝的美女","quality":"auto","size":"1024x1024"}	<html>\r\n<head><title>503 Service Temporarily Unavailable</title></head>\r\n<body>\r\n<center><h1>503 Service Temporarily Unavailable</h1></center>\r\n<hr><center>nginx</center>\r\n</body>\r\n</html>\r\n	{"background":"auto","model":"gpt-image-2","n":1,"output_format":"png","prompt":"一个在躺在酒店穿着黑丝的美女","quality":"auto","size":"1024x1024"}	0	\N	2026-04-28 19:18:08.127309+00	0		图片
75	a6fde4b2-5728-4fbb-b14c-de4934cb66da	2	13	doubao-seedream-4-0-250828	0	4096	0.25	9776	200	/v1/images/generations	\N	/api/v3/images/generations	{"guidance_scale":7,"model":"doubao-seedream-4-0-250828","n":1,"prompt":"一个在躺在酒店穿着黑丝的美女","ratio":"1:1","size":"1024x1024","watermark":false}	{"model":"doubao-seedream-4-0-250828","created":1777403918,"data":[{"url":"https://ark-content-generation-v2-cn-beijing.tos-cn-beijing.volces.com/doubao-seedream-4-0/0217774039131995630b2fa661ac131412e72f6bdd3759fe78d7b_0.jpeg?X-Tos-Algorithm=TOS4-HMAC-SHA256&X-Tos-Credential=AKLTYWJkZTExNjA1ZDUyNDc3YzhjNTM5OGIyNjBhNDcyOTQ%2F20260428%2Fcn-beijing%2Ftos%2Frequest&X-Tos-Date=20260428T191838Z&X-Tos-Expires=86400&X-Tos-Signature=2f6d822d776d15aa1bb6dc253690cffb7b5864f1c4c2cf4ad7b013bc561ec9d9&X-Tos-SignedHeaders=host","size":"1024x1024"}],"usage":{"generated_images":1,"output_tokens":4096,"total_tokens":4096}}\n	{"guidance_scale":7,"model":"doubao-seedream-4-0-250828","prompt":"一个在躺在酒店穿着黑丝的美女","ratio":"1:1","size":"1024x1024","watermark":false}	0	按张返回计费 -> (1量 * 0.250000单价 * 1.00倍率) | 等级折扣	2026-04-28 19:18:38.825623+00	0		图片
59	464fdb02-5e2f-4979-89d1-77da502682f6	3	12	doubao-seedance-2-0-fast-260128	0	50638	1.873606	169092	200	/v1/video/generations	\N	https://ark.cn-beijing.volces.com/api/v3/contents/generations/tasks	{"camera_fixed":false,"content":[{"text":"按照图一做一段模特拍照换装的广告视频，需要使用图 1 2 3 的所有服装","type":"text"},{"image_url":{"url":"https://s3.artsapi.com/chedev/1000090577/dsdsd/3a314a60-76c7-4f19-a2f4-ae2cade2e1dc.jpg"},"role":"reference_image","type":"image_url"},{"image_url":{"url":"https://s3.artsapi.com/chedev/1000090577/dsdsd/78e5c88a-3b80-42e3-94c0-333af81e4a5e.jpg"},"role":"reference_image","type":"image_url"},{"image_url":{"url":"https://s3.artsapi.com/chedev/1000090577/dsdsd/8ebb5536-808e-4c07-ac9c-28bfee1cbee3.jpg"},"role":"reference_image","type":"image_url"}],"duration":5,"generate_audio":true,"model":"doubao-seedance-2-0-fast-260128","ratio":"9:16","resolution":"480p","return_last_frame":false,"seed":-1,"watermark":false}	{"id":"cgt-20260428225817-dc9b9","model":"doubao-seedance-2-0-fast-260128","status":"succeeded","content":{"video_url":"https://ark-acg-cn-beijing.tos-cn-beijing.volces.com/doubao-seedance-2-0-fast/02177738829786200000000000000000000ffffac157b31130f34.mp4?X-Tos-Algorithm=TOS4-HMAC-SHA256&X-Tos-Credential=AKLTYWJkZTExNjA1ZDUyNDc3YzhjNTM5OGIyNjBhNDcyOTQ%2F20260428%2Fcn-beijing%2Ftos%2Frequest&X-Tos-Date=20260428T150009Z&X-Tos-Expires=86400&X-Tos-Signature=eed8029cfd385328f4b8de08ac44b1445f079e4e6b37d57fc7d3be7ca7353bf8&X-Tos-SignedHeaders=host"},"usage":{"completion_tokens":50638,"total_tokens":50638},"created_at":1777388297,"updated_at":1777388463,"seed":68256,"resolution":"480p","ratio":"9:16","duration":5,"framespersecond":24,"service_tier":"default","execution_expires_after":172800,"generate_audio":true,"draft":false}\n	{"content":[{"text":"按照图一做一段模特拍照换装的广告视频，需要使用图 1 2 3 的所有服装","type":"text"},{"image_url":{"url":"asset://asset-20260428174153-lmbk8"},"role":"reference_image","type":"image_url"},{"image_url":{"url":"asset://asset-20260428224919-7x74q"},"role":"reference_image","type":"image_url"},{"image_url":{"url":"asset://asset-20260428182345-mr4jz"},"role":"reference_image","type":"image_url"}],"duration":5,"generate_audio":true,"model":"ep-20260423183947-rhw99","ratio":"9:16","resolution":"480p","return_last_frame":false,"seed":-1,"watermark":false}	0	Seedance2.0(480p|无视频|基本单价:37) -> (0P*37 + 50638C*37)/1M * 1.00倍率 | 等级折扣 | 模型映射: doubao-seedance-2-0-fast-260128 ➞ ep-20260423183947-rhw99	2026-04-28 14:58:19.026228+00	0		视频
60	464fdb02-5e2f-4979-89d1-77da502682f6	3	12	doubao-seedance-2-0-fast-260128	0	100858	3.731746	186226	200	/v1/video/generations	\N	https://ark.cn-beijing.volces.com/api/v3/contents/generations/tasks	{"camera_fixed":false,"content":[{"text":"把这个图片上的这个蓝色的衣服换到这个图 1 的视频身上。","type":"text"},{"image_url":{"url":""base64数据""},"role":"reference_image","type":"image_url"},{"role":"reference_video","type":"video_url","video_url":{"url":""base64数据""}}],"duration":5,"generate_audio":true,"model":"doubao-seedance-2-0-fast-260128","ratio":"16:9","resolution":"480p","return_last_frame":true,"seed":-1,"watermark":false}	{"id":"cgt-20260428233643-jk4pb","model":"doubao-seedance-2-0-fast-260128","status":"succeeded","content":{"video_url":"https://ark-acg-cn-beijing.tos-cn-beijing.volces.com/doubao-seedance-2-0-fast/02177739068497100000000000000000000ffffac1778ad36053f.mp4?X-Tos-Algorithm=TOS4-HMAC-SHA256&X-Tos-Credential=AKLTYWJkZTExNjA1ZDUyNDc3YzhjNTM5OGIyNjBhNDcyOTQ%2F20260428%2Fcn-beijing%2Ftos%2Frequest&X-Tos-Date=20260428T153934Z&X-Tos-Expires=86400&X-Tos-Signature=b51ed4fc0ab8df726fe4983a8c3eb8c098ab20493dc5512de89a3455ac898343&X-Tos-SignedHeaders=host","last_frame_url":"https://ark-acg-cn-beijing.tos-cn-beijing.volces.com/doubao-seedance-2-0-fast/02177739068497100000000000000000000ffffac1778ad36053f_last-frame.png?X-Tos-Algorithm=TOS4-HMAC-SHA256&X-Tos-Credential=AKLTYWJkZTExNjA1ZDUyNDc3YzhjNTM5OGIyNjBhNDcyOTQ%2F20260428%2Fcn-beijing%2Ftos%2Frequest&X-Tos-Date=20260428T153934Z&X-Tos-Expires=86400&X-Tos-Signature=3fc4cdbac2e377bbfb28c45f2454181367d8710e21fbff2f5ac2f753d3a852a1&X-Tos-SignedHeaders=host"},"usage":{"completion_tokens":100858,"total_tokens":100858},"created_at":1777390604,"updated_at":1777390790,"seed":92139,"resolution":"480p","ratio":"16:9","duration":5,"framespersecond":24,"service_tier":"default","execution_expires_after":172800,"generate_audio":true,"draft":false}\n	{"content":[{"text":"把这个图片上的这个蓝色的衣服换到这个图 1 的视频身上。","type":"text"},{"image_url":{"url":"asset://asset-20260428233550-5l5zz"},"role":"reference_image","type":"image_url"},{"role":"reference_video","type":"video_url","video_url":{"url":"asset://asset-20260428233612-cjjrv"}}],"duration":5,"generate_audio":true,"model":"ep-20260423183947-rhw99","ratio":"16:9","resolution":"480p","return_last_frame":true,"seed":-1,"watermark":false}	0	Seedance2.0(480p|无视频|基本单价:37) -> (0P*37 + 100858C*37)/1M * 1.00倍率 | 等级折扣 | 模型映射: doubao-seedance-2-0-fast-260128 ➞ ep-20260423183947-rhw99	2026-04-28 15:36:45.70731+00	0		视频
14	937afe47-9cd7-4ee8-9a22-fe4bd7720b34	1	1	doubao-seedream-4-0-250828	0	4096	0.2	10168	200	/v1/images/generations	\N	https://ark.cn-beijing.volces.com/api/v3/images/generations	{"guidance_scale":7,"model":"doubao-seedream-4-0-250828","n":1,"prompt":"一个美女在咖啡店喝咖啡","ratio":"1:1","size":"1024x1024","watermark":false}	{"model":"doubao-seedream-4-0-250828","created":1777105055,"data":[{"url":"https://ark-content-generation-v2-cn-beijing.tos-cn-beijing.volces.com/doubao-seedream-4-0/021777105048101ad6686bf264e1cfa8d614a02b293f5e0b62351_0.jpeg?X-Tos-Algorithm=TOS4-HMAC-SHA256&X-Tos-Credential=AKLTYWJkZTExNjA1ZDUyNDc3YzhjNTM5OGIyNjBhNDcyOTQ%2F20260425%2Fcn-beijing%2Ftos%2Frequest&X-Tos-Date=20260425T081735Z&X-Tos-Expires=86400&X-Tos-Signature=f97589bba2a23459ed3853c934d3cb9a95660caee33e4c8cc296ea935442a459&X-Tos-SignedHeaders=host","size":"1024x1024"}],"usage":{"generated_images":1,"output_tokens":4096,"total_tokens":4096}}\n	{"guidance_scale":7,"model":"doubao-seedream-4-0-250828","prompt":"一个美女在咖啡店喝咖啡","ratio":"1:1","size":"1024x1024","watermark":false}	0	固定按次计费 -> (1量 * 0.2单价 * 1.00倍率) | 等级折扣	2026-04-25 08:17:36.543489+00	0		图片
15	fc03127f-3d70-4c40-9a23-5a698ea80e57	1	2	doubao-seedream-4-0-250828	0	4096	0.2	14516	200	/v1/images/generations	\N	https://ark.cn-beijing.volces.com/api/v3/images/generations	{"guidance_scale":7,"model":"doubao-seedream-4-0-250828","n":1,"prompt":"一个亚洲长发大波浪美女，穿着吊带的白色上衣，露出双肩在咖啡店喝咖啡。","ratio":"1:1","size":"1024x1024","watermark":false}	{"model":"doubao-seedream-4-0-250828","created":1777107975,"data":[{"url":"https://ark-content-generation-v2-cn-beijing.tos-cn-beijing.volces.com/doubao-seedream-4-0/021777107963005ddbe0d776ca28054411b6866ea9771fcdc0db9_0.jpeg?X-Tos-Algorithm=TOS4-HMAC-SHA256&X-Tos-Credential=AKLTYWJkZTExNjA1ZDUyNDc3YzhjNTM5OGIyNjBhNDcyOTQ%2F20260425%2Fcn-beijing%2Ftos%2Frequest&X-Tos-Date=20260425T090615Z&X-Tos-Expires=86400&X-Tos-Signature=5bbadb8a9eb744c83008fca8f58bcd96dea43d73d60ba6ae5f88395f273398c7&X-Tos-SignedHeaders=host","size":"1024x1024"}],"usage":{"generated_images":1,"output_tokens":4096,"total_tokens":4096}}\n	{"guidance_scale":7,"model":"doubao-seedream-4-0-250828","prompt":"一个亚洲长发大波浪美女，穿着吊带的白色上衣，露出双肩在咖啡店喝咖啡。","ratio":"1:1","size":"1024x1024","watermark":false}	0	固定按次计费 -> (1量 * 0.2单价 * 1.00倍率) | 等级折扣	2026-04-25 09:06:15.854971+00	0		图片
32	7fc96805-e78e-431d-8b6d-8a54fd18ae2a	1	6	doubao-seedream-4-0-250828	0	4096	0.2	15843	200	/v1/images/generations	\N	https://ark.cn-beijing.volces.com/api/v3/images/generations	{"guidance_scale":7,"image":""base64数据"","image_url":""base64数据"","model":"doubao-seedream-4-0-250828","n":1,"prompt":"把这个衣服换成黑色的","ratio":"1:1","size":"1024x1024","watermark":false}	{"model":"doubao-seedream-4-0-250828","created":1777139566,"data":[{"url":"https://ark-content-generation-v2-cn-beijing.tos-cn-beijing.volces.com/doubao-seedream-4-0/021777139550443e3fc3002f37f70960f01c9f37bff6e82e86825_0.jpeg?X-Tos-Algorithm=TOS4-HMAC-SHA256&X-Tos-Credential=AKLTYWJkZTExNjA1ZDUyNDc3YzhjNTM5OGIyNjBhNDcyOTQ%2F20260425%2Fcn-beijing%2Ftos%2Frequest&X-Tos-Date=20260425T175246Z&X-Tos-Expires=86400&X-Tos-Signature=10f194e85f1151270f2cbe02f30f6e38284b07360041a27191d145f7ffe902fa&X-Tos-SignedHeaders=host","size":"1024x1024"}],"usage":{"generated_images":1,"output_tokens":4096,"total_tokens":4096}}\n	{"guidance_scale":7,"image":""base64数据"","image_url":""base64数据"","model":"doubao-seedream-4-0-250828","prompt":"把这个衣服换成黑色的","ratio":"1:1","size":"1024x1024","watermark":false}	0	固定按次计费 -> (1量 * 0.2单价 * 1.00倍率) | 等级折扣	2026-04-25 17:52:46.17062+00	0		图片
76	unknown	0	0	unknown	0	0	0	0	401	/	Missing Authorization Header		\N	\N	\N	0		2026-04-29 01:19:10.254846+00	0		其它
77	unknown	0	0	unknown	0	0	0	0	401	/login	Missing Authorization Header		\N	\N	\N	0		2026-04-29 01:22:27.837655+00	0		其它
16	fc03127f-3d70-4c40-9a23-5a698ea80e57	1	2	doubao-seedream-4-0-250828	0	4096	0.2	9255	200	/v1/images/generations	\N	https://ark.cn-beijing.volces.com/api/v3/images/generations	{"guidance_scale":7,"model":"doubao-seedream-4-0-250828","n":1,"prompt":"一个亚洲长发大波浪美女侧身坐在椅子上，翘着二郎腿，穿着黑色丝袜和高跟鞋，短裙，穿着吊带的白色上衣，露出双肩在咖啡店喝咖啡。","ratio":"1:1","size":"1024x1024","watermark":false}	{"model":"doubao-seedream-4-0-250828","created":1777108763,"data":[{"url":"https://ark-content-generation-v2-cn-beijing.tos-cn-beijing.volces.com/doubao-seedream-4-0/021777108757378b9f1f8d82739748c57f1ca9984b4fb5eb5f52a_0.jpeg?X-Tos-Algorithm=TOS4-HMAC-SHA256&X-Tos-Credential=AKLTYWJkZTExNjA1ZDUyNDc3YzhjNTM5OGIyNjBhNDcyOTQ%2F20260425%2Fcn-beijing%2Ftos%2Frequest&X-Tos-Date=20260425T091923Z&X-Tos-Expires=86400&X-Tos-Signature=bb90a02055ef1a7add9403960357e1c2fe220bd58af9bdb7ecd1a30c03b65367&X-Tos-SignedHeaders=host","size":"1024x1024"}],"usage":{"generated_images":1,"output_tokens":4096,"total_tokens":4096}}\n	{"guidance_scale":7,"model":"doubao-seedream-4-0-250828","prompt":"一个亚洲长发大波浪美女侧身坐在椅子上，翘着二郎腿，穿着黑色丝袜和高跟鞋，短裙，穿着吊带的白色上衣，露出双肩在咖啡店喝咖啡。","ratio":"1:1","size":"1024x1024","watermark":false}	0	固定按次计费 -> (1量 * 0.2单价 * 1.00倍率) | 等级折扣	2026-04-25 09:19:25.123695+00	0		图片
17	fc03127f-3d70-4c40-9a23-5a698ea80e57	1	2	doubao-seedream-4-0-250828	0	4096	0.2	17229	200	/v1/images/generations	\N	https://ark.cn-beijing.volces.com/api/v3/images/generations	{"guidance_scale":7,"model":"doubao-seedream-4-0-250828","n":1,"prompt":"咋大街上等打车","ratio":"1:1","size":"1024x1024","watermark":false}	{"model":"doubao-seedream-4-0-250828","created":1777109045,"data":[{"url":"https://ark-content-generation-v2-cn-beijing.tos-cn-beijing.volces.com/doubao-seedream-4-0/021777109030837c42f47c04edb3ff7f5c9773198a61a0cafa7a8_0.jpeg?X-Tos-Algorithm=TOS4-HMAC-SHA256&X-Tos-Credential=AKLTYWJkZTExNjA1ZDUyNDc3YzhjNTM5OGIyNjBhNDcyOTQ%2F20260425%2Fcn-beijing%2Ftos%2Frequest&X-Tos-Date=20260425T092405Z&X-Tos-Expires=86400&X-Tos-Signature=222fb13605d5de4d3498a273fac4829faa1959c63b4e851e3469d2fd6200beb6&X-Tos-SignedHeaders=host","size":"1024x1024"}],"usage":{"generated_images":1,"output_tokens":4096,"total_tokens":4096}}\n	{"guidance_scale":7,"model":"doubao-seedream-4-0-250828","prompt":"咋大街上等打车","ratio":"1:1","size":"1024x1024","watermark":false}	0	固定按次计费 -> (1量 * 0.2单价 * 1.00倍率) | 等级折扣	2026-04-25 09:24:06.714+00	0		图片
18	92086673-19cd-43e5-81ca-fdf34c06fdaa	1	3	doubao-seedream-4-0-250828	0	4096	0.2	7139	200	/v1/images/generations	\N	https://ark.cn-beijing.volces.com/api/v3/images/generations	{"guidance_scale":7,"model":"doubao-seedream-4-0-250828","n":1,"prompt":"一个亚洲长发大波浪美女侧身坐在椅子上，一个很舒服的姿势，翘着二郎腿，穿着黑色丝袜和黑色细跟高跟鞋，短裙，穿着吊带的白色上衣，露出双肩在咖啡店喝咖啡。","ratio":"1:1","size":"1024x1024","watermark":false}	{"model":"doubao-seedream-4-0-250828","created":1777110386,"data":[{"url":"https://ark-content-generation-v2-cn-beijing.tos-cn-beijing.volces.com/doubao-seedream-4-0/0217771103811698c8bbeccabd2a8badabcecc7b49ff2427ddb60_0.jpeg?X-Tos-Algorithm=TOS4-HMAC-SHA256&X-Tos-Credential=AKLTYWJkZTExNjA1ZDUyNDc3YzhjNTM5OGIyNjBhNDcyOTQ%2F20260425%2Fcn-beijing%2Ftos%2Frequest&X-Tos-Date=20260425T094626Z&X-Tos-Expires=86400&X-Tos-Signature=6f081d83a57da4a18620ab60f9fcc4eed76436c655dba9e9f1094b93c64ed410&X-Tos-SignedHeaders=host","size":"1024x1024"}],"usage":{"generated_images":1,"output_tokens":4096,"total_tokens":4096}}\n	{"guidance_scale":7,"model":"doubao-seedream-4-0-250828","prompt":"一个亚洲长发大波浪美女侧身坐在椅子上，一个很舒服的姿势，翘着二郎腿，穿着黑色丝袜和黑色细跟高跟鞋，短裙，穿着吊带的白色上衣，露出双肩在咖啡店喝咖啡。","ratio":"1:1","size":"1024x1024","watermark":false}	0	固定按次计费 -> (1量 * 0.2单价 * 1.00倍率) | 等级折扣	2026-04-25 09:46:27.546633+00	0		图片
19	92086673-19cd-43e5-81ca-fdf34c06fdaa	1	3	doubao-seedream-4-0-250828	0	4096	0.2	8906	200	/v1/images/generations	\N	https://ark.cn-beijing.volces.com/api/v3/images/generations	{"guidance_scale":7,"model":"doubao-seedream-4-0-250828","n":1,"prompt":"一个亚洲长发大波浪正面斜着镜头坐在椅子上，一个很舒服的姿势，翘着二郎腿，穿着黑色丝袜和黑色细跟高跟鞋，黑色蕾丝吊带包臀连衣裙。，露出双肩在咖啡店喝咖啡。","ratio":"1:1","size":"1024x1024","watermark":false}	{"model":"doubao-seedream-4-0-250828","created":1777110490,"data":[{"url":"https://ark-content-generation-v2-cn-beijing.tos-cn-beijing.volces.com/doubao-seedream-4-0/021777110483880b556cf4da499f5769ee5b78217b3f91a3fd89c_0.jpeg?X-Tos-Algorithm=TOS4-HMAC-SHA256&X-Tos-Credential=AKLTYWJkZTExNjA1ZDUyNDc3YzhjNTM5OGIyNjBhNDcyOTQ%2F20260425%2Fcn-beijing%2Ftos%2Frequest&X-Tos-Date=20260425T094810Z&X-Tos-Expires=86400&X-Tos-Signature=1246ce5901dd4e0f8d3c75dadb202049231da4bf601a4664b8d58bd69f67966f&X-Tos-SignedHeaders=host","size":"1024x1024"}],"usage":{"generated_images":1,"output_tokens":4096,"total_tokens":4096}}\n	{"guidance_scale":7,"model":"doubao-seedream-4-0-250828","prompt":"一个亚洲长发大波浪正面斜着镜头坐在椅子上，一个很舒服的姿势，翘着二郎腿，穿着黑色丝袜和黑色细跟高跟鞋，黑色蕾丝吊带包臀连衣裙。，露出双肩在咖啡店喝咖啡。","ratio":"1:1","size":"1024x1024","watermark":false}	0	固定按次计费 -> (1量 * 0.2单价 * 1.00倍率) | 等级折扣	2026-04-25 09:48:11.991322+00	0		图片
20	47aaabf0-7e6a-42a1-a951-bdec068f3024	1	4	doubao-seedream-4-0-250828	0	4096	0.2	9908	200	/v1/images/generations	\N	https://ark.cn-beijing.volces.com/api/v3/images/generations	{"guidance_scale":7,"model":"doubao-seedream-4-0-250828","n":1,"prompt":"一个长发大波浪正面斜着镜头坐在椅子上，一个很舒服的姿势，翘着二郎腿，穿着黑色丝袜和黑色红底细跟高跟鞋，白色蕾丝吊带包臀连衣裙，露出双肩在咖啡店喝咖啡。","ratio":"1:1","size":"1024x1024","watermark":false}	{"model":"doubao-seedream-4-0-250828","created":1777111625,"data":[{"url":"https://ark-content-generation-v2-cn-beijing.tos-cn-beijing.volces.com/doubao-seedream-4-0/02177711161862248e5da24e8965daa10accd59f6411c73ac3067_0.jpeg?X-Tos-Algorithm=TOS4-HMAC-SHA256&X-Tos-Credential=AKLTYWJkZTExNjA1ZDUyNDc3YzhjNTM5OGIyNjBhNDcyOTQ%2F20260425%2Fcn-beijing%2Ftos%2Frequest&X-Tos-Date=20260425T100705Z&X-Tos-Expires=86400&X-Tos-Signature=bb0da1e1dc5d4dc0a07ad449f3fe8f78dd1368159aca1eb277c05ea5aa523232&X-Tos-SignedHeaders=host","size":"1024x1024"}],"usage":{"generated_images":1,"output_tokens":4096,"total_tokens":4096}}\n	{"guidance_scale":7,"model":"doubao-seedream-4-0-250828","prompt":"一个长发大波浪正面斜着镜头坐在椅子上，一个很舒服的姿势，翘着二郎腿，穿着黑色丝袜和黑色红底细跟高跟鞋，白色蕾丝吊带包臀连衣裙，露出双肩在咖啡店喝咖啡。","ratio":"1:1","size":"1024x1024","watermark":false}	0	固定按次计费 -> (1量 * 0.2单价 * 1.00倍率) | 等级折扣	2026-04-25 10:07:06.065257+00	0		图片
21	47aaabf0-7e6a-42a1-a951-bdec068f3024	1	4	doubao-seedream-4-0-250828	0	4096	0.2	7192	200	/v1/images/generations	\N	https://ark.cn-beijing.volces.com/api/v3/images/generations	{"guidance_scale":7,"model":"doubao-seedream-4-0-250828","n":1,"prompt":"一个长发大波浪亚洲模特网红美女正面斜着镜头坐在椅子上，一个很舒服的姿势，翘着二郎腿，穿着黑色丝袜和黑色红底细跟高跟鞋，白色蕾丝吊带包臀连衣裙，露出双肩在咖啡店喝咖啡。","ratio":"1:1","size":"1024x1024","watermark":false}	{"model":"doubao-seedream-4-0-250828","created":1777111667,"data":[{"url":"https://ark-content-generation-v2-cn-beijing.tos-cn-beijing.volces.com/doubao-seedream-4-0/02177711166168148e5da24e8965daa10accd59f6411c734d69df_0.jpeg?X-Tos-Algorithm=TOS4-HMAC-SHA256&X-Tos-Credential=AKLTYWJkZTExNjA1ZDUyNDc3YzhjNTM5OGIyNjBhNDcyOTQ%2F20260425%2Fcn-beijing%2Ftos%2Frequest&X-Tos-Date=20260425T100747Z&X-Tos-Expires=86400&X-Tos-Signature=a250f8ad1f7fbdfab7924da6801be5be949f7ff1ba457f5d0cc7626998010590&X-Tos-SignedHeaders=host","size":"1024x1024"}],"usage":{"generated_images":1,"output_tokens":4096,"total_tokens":4096}}\n	{"guidance_scale":7,"model":"doubao-seedream-4-0-250828","prompt":"一个长发大波浪亚洲模特网红美女正面斜着镜头坐在椅子上，一个很舒服的姿势，翘着二郎腿，穿着黑色丝袜和黑色红底细跟高跟鞋，白色蕾丝吊带包臀连衣裙，露出双肩在咖啡店喝咖啡。","ratio":"1:1","size":"1024x1024","watermark":false}	0	固定按次计费 -> (1量 * 0.2单价 * 1.00倍率) | 等级折扣	2026-04-25 10:07:49.084683+00	0		图片
22	47aaabf0-7e6a-42a1-a951-bdec068f3024	1	4	doubao-seedream-4-0-250828	0	4096	0.2	10841	200	/v1/images/generations	\N	https://ark.cn-beijing.volces.com/api/v3/images/generations	{"guidance_scale":5,"model":"doubao-seedream-4-0-250828","n":2,"prompt":"一个亚洲长发大波浪正面斜着镜头坐在椅子上身材完美比例，一个很舒服的姿势，座子为矜持怕走光的姿势，穿着黑色丝袜和黑色很细跟高跟鞋，低胸白色吊带包臀连衣裙，在咖啡店看着窗外喝咖啡。","ratio":"1:1","size":"1024x1024","watermark":true}	{"model":"doubao-seedream-4-0-250828","created":1777115935,"data":[{"url":"https://ark-content-generation-v2-cn-beijing.tos-cn-beijing.volces.com/doubao-seedream-4-0/0217771159273999e9a0f81d29869daa108a627170bdfb2e3b841_0.jpeg?X-Tos-Algorithm=TOS4-HMAC-SHA256&X-Tos-Credential=AKLTYWJkZTExNjA1ZDUyNDc3YzhjNTM5OGIyNjBhNDcyOTQ%2F20260425%2Fcn-beijing%2Ftos%2Frequest&X-Tos-Date=20260425T111855Z&X-Tos-Expires=86400&X-Tos-Signature=a3cb1e0e8a4c9c3fea00cdafdd0444c00308a032b38c4ccdb118dd615df361be&X-Tos-SignedHeaders=host","size":"1024x1024"}],"usage":{"generated_images":1,"output_tokens":4096,"total_tokens":4096}}\n	{"guidance_scale":5,"model":"doubao-seedream-4-0-250828","prompt":"一个亚洲长发大波浪正面斜着镜头坐在椅子上身材完美比例，一个很舒服的姿势，座子为矜持怕走光的姿势，穿着黑色丝袜和黑色很细跟高跟鞋，低胸白色吊带包臀连衣裙，在咖啡店看着窗外喝咖啡。","ratio":"1:1","sequential_image_generation":"auto","sequential_image_generation_options":{"max_images":2},"size":"1024x1024","watermark":true}	0	固定按次计费 -> (1量 * 0.2单价 * 1.00倍率) | 等级折扣	2026-04-25 11:18:56.021191+00	0		图片
28	10cbc711-bbc2-4f9a-9fab-a7d09fc6eb48	1	5	doubao-seedream-4-0-250828	0	4096	0.2	10362	200	/v1/images/generations	\N	https://ark.cn-beijing.volces.com/api/v3/images/generations	{"guidance_scale":7,"model":"doubao-seedream-4-0-250828","n":1,"prompt":"参考图片里面的这个白色的衣服换成蓝色的。","ratio":"1:1","size":"1024x1024","watermark":false}	{"model":"doubao-seedream-4-0-250828","created":1777122753,"data":[{"url":"https://ark-content-generation-v2-cn-beijing.tos-cn-beijing.volces.com/doubao-seedream-4-0/021777122746651fa647a4e0ad2c514964a6296626d67a0d15d3e_0.jpeg?X-Tos-Algorithm=TOS4-HMAC-SHA256&X-Tos-Credential=AKLTYWJkZTExNjA1ZDUyNDc3YzhjNTM5OGIyNjBhNDcyOTQ%2F20260425%2Fcn-beijing%2Ftos%2Frequest&X-Tos-Date=20260425T131233Z&X-Tos-Expires=86400&X-Tos-Signature=3053e9e78bfbb9d462ef4570c3f56be94f4bc2d6700ade7c356d09b4facc76d2&X-Tos-SignedHeaders=host","size":"1024x1024"}],"usage":{"generated_images":1,"output_tokens":4096,"total_tokens":4096}}\n	{"guidance_scale":7,"model":"doubao-seedream-4-0-250828","prompt":"参考图片里面的这个白色的衣服换成蓝色的。","ratio":"1:1","size":"1024x1024","watermark":false}	0	固定按次计费 -> (1量 * 0.2单价 * 1.00倍率) | 等级折扣	2026-04-25 13:12:35.06066+00	0		图片
29	7fc96805-e78e-431d-8b6d-8a54fd18ae2a	1	6	doubao-seedream-4-0-250828	0	4096	0.2	11896	200	/v1/images/generations	\N	https://ark.cn-beijing.volces.com/api/v3/images/generations	{"guidance_scale":7,"image":"https://s3.artsapi.com/chedev/1001198464/jkll/1abc2359-8344-4c25-8274-ac4998de5d5d.jpg","image_url":"https://s3.artsapi.com/chedev/1001198464/jkll/1abc2359-8344-4c25-8274-ac4998de5d5d.jpg","model":"doubao-seedream-4-0-250828","n":1,"prompt":"吧这个任务的的上衣换成黑色","ratio":"1:1","size":"1024x1024","watermark":false}	{"model":"doubao-seedream-4-0-250828","created":1777126267,"data":[{"url":"https://ark-content-generation-v2-cn-beijing.tos-cn-beijing.volces.com/doubao-seedream-4-0/021777126258103a65bb9cc875deec710c23fb9efaa4f4b46d309_0.jpeg?X-Tos-Algorithm=TOS4-HMAC-SHA256&X-Tos-Credential=AKLTYWJkZTExNjA1ZDUyNDc3YzhjNTM5OGIyNjBhNDcyOTQ%2F20260425%2Fcn-beijing%2Ftos%2Frequest&X-Tos-Date=20260425T141107Z&X-Tos-Expires=86400&X-Tos-Signature=f896c429bd057196823c3e5cc7dbfa6c342d2794175f8177591636f5c2976303&X-Tos-SignedHeaders=host","size":"1024x1024"}],"usage":{"generated_images":1,"output_tokens":4096,"total_tokens":4096}}\n	{"guidance_scale":7,"image":"https://s3.artsapi.com/chedev/1001198464/jkll/1abc2359-8344-4c25-8274-ac4998de5d5d.jpg","image_url":"https://s3.artsapi.com/chedev/1001198464/jkll/1abc2359-8344-4c25-8274-ac4998de5d5d.jpg","model":"doubao-seedream-4-0-250828","prompt":"吧这个任务的的上衣换成黑色","ratio":"1:1","size":"1024x1024","watermark":false}	0	固定按次计费 -> (1量 * 0.2单价 * 1.00倍率) | 等级折扣	2026-04-25 14:11:08.591613+00	0		图片
30	7fc96805-e78e-431d-8b6d-8a54fd18ae2a	1	6	doubao-seedream-4-0-250828	0	4096	0.2	10925	200	/v1/images/generations	\N	https://ark.cn-beijing.volces.com/api/v3/images/generations	{"guidance_scale":7,"image":""base64数据"","image_url":""base64数据"","model":"doubao-seedream-4-0-250828","n":1,"prompt":"把我画黄圈的这朵花给它扣除掉。","ratio":"1:1","size":"1024x1024","watermark":false}	{"model":"doubao-seedream-4-0-250828","created":1777135425,"data":[{"url":"https://ark-content-generation-v2-cn-beijing.tos-cn-beijing.volces.com/doubao-seedream-4-0/021777135414719c57e78ec35a4c62cb30347d58d08558fc646a9_0.jpeg?X-Tos-Algorithm=TOS4-HMAC-SHA256&X-Tos-Credential=AKLTYWJkZTExNjA1ZDUyNDc3YzhjNTM5OGIyNjBhNDcyOTQ%2F20260425%2Fcn-beijing%2Ftos%2Frequest&X-Tos-Date=20260425T164345Z&X-Tos-Expires=86400&X-Tos-Signature=df34b9ae2ea384ed7cdba5e912602ac85ec5bc49be1515497a0cea4f7aec5f95&X-Tos-SignedHeaders=host","size":"1024x1024"}],"usage":{"generated_images":1,"output_tokens":4096,"total_tokens":4096}}\n	{"guidance_scale":7,"image":""base64数据"","image_url":""base64数据"","model":"doubao-seedream-4-0-250828","prompt":"把我画黄圈的这朵花给它扣除掉。","ratio":"1:1","size":"1024x1024","watermark":false}	0	固定按次计费 -> (1量 * 0.2单价 * 1.00倍率) | 等级折扣	2026-04-25 16:43:45.352248+00	0		图片
33	4d77d157-71aa-409a-adf2-19ade50ed63e	1	7	doubao-seedream-4-0-250828	0	4096	0.2	7239	200	/v1/images/generations	\N	https://ark.cn-beijing.volces.com/api/v3/images/generations	{"guidance_scale":7,"image":""base64数据"","image_url":""base64数据"","model":"doubao-seedream-4-0-250828","n":1,"prompt":"把这个衣服变成白色","ratio":"1:1","size":"1024x1024","watermark":false}	{"model":"doubao-seedream-4-0-250828","created":1777140629,"data":[{"url":"https://ark-content-generation-v2-cn-beijing.tos-cn-beijing.volces.com/doubao-seedream-4-0/021777140622798b6043c5851c0a2627b25b78c406cf304277cea_0.jpeg?X-Tos-Algorithm=TOS4-HMAC-SHA256&X-Tos-Credential=AKLTYWJkZTExNjA1ZDUyNDc3YzhjNTM5OGIyNjBhNDcyOTQ%2F20260425%2Fcn-beijing%2Ftos%2Frequest&X-Tos-Date=20260425T181029Z&X-Tos-Expires=86400&X-Tos-Signature=d1a9cee9fb3ab854c6d335692f3e1d304064758b2e59ecc059bb16aef63142cd&X-Tos-SignedHeaders=host","size":"1024x1024"}],"usage":{"generated_images":1,"output_tokens":4096,"total_tokens":4096}}\n	{"guidance_scale":7,"image":""base64数据"","image_url":""base64数据"","model":"doubao-seedream-4-0-250828","prompt":"把这个衣服变成白色","ratio":"1:1","size":"1024x1024","watermark":false}	0	固定按次计费 -> (1量 * 0.2单价 * 1.00倍率) | 等级折扣	2026-04-25 18:10:29.800446+00	0		图片
34	4d77d157-71aa-409a-adf2-19ade50ed63e	1	7	doubao-seedream-4-0-250828	0	4096	0.2	28884	200	/v1/images/generations	\N	https://ark.cn-beijing.volces.com/api/v3/images/generations	{"guidance_scale":7,"image":""base64数据"","image_url":""base64数据"","model":"doubao-seedream-4-0-250828","n":1,"prompt":"吧图 2 的衣服换到图 1 上面去","ratio":"1:1","size":"1024x1024","watermark":false}	{"model":"doubao-seedream-4-0-250828","created":1777141901,"data":[{"url":"https://ark-content-generation-v2-cn-beijing.tos-cn-beijing.volces.com/doubao-seedream-4-0/021777141873266b81e7dc348dc6944e7af7515bd42f6ba52faa5_0.jpeg?X-Tos-Algorithm=TOS4-HMAC-SHA256&X-Tos-Credential=AKLTYWJkZTExNjA1ZDUyNDc3YzhjNTM5OGIyNjBhNDcyOTQ%2F20260425%2Fcn-beijing%2Ftos%2Frequest&X-Tos-Date=20260425T183141Z&X-Tos-Expires=86400&X-Tos-Signature=57cccae4f61354788dc31cf54d7d60ef0585e8463826d431142b8e35881ac881&X-Tos-SignedHeaders=host","size":"1024x1024"}],"usage":{"generated_images":1,"output_tokens":4096,"total_tokens":4096}}\n	{"guidance_scale":7,"image":""base64数据"","image_url":""base64数据"","model":"doubao-seedream-4-0-250828","prompt":"吧图 2 的衣服换到图 1 上面去","ratio":"1:1","size":"1024x1024","watermark":false}	0	固定按次计费 -> (1量 * 0.2单价 * 1.00倍率) | 等级折扣	2026-04-25 18:31:41.876601+00	0		图片
35	4d77d157-71aa-409a-adf2-19ade50ed63e	1	7	doubao-seedream-4-0-250828	0	4096	0.2	28285	200	/v1/images/generations	\N	https://ark.cn-beijing.volces.com/api/v3/images/generations	{"guidance_scale":7,"image":""base64数据"","image_url":""base64数据"","model":"doubao-seedream-4-0-250828","n":1,"prompt":"吧图一的上衣换到图二身上","ratio":"1:1","size":"1024x1024","watermark":false}	{"model":"doubao-seedream-4-0-250828","created":1777142131,"data":[{"url":"https://ark-content-generation-v2-cn-beijing.tos-cn-beijing.volces.com/doubao-seedream-4-0/0217771421032316c842ac2497beff864ff783c000b2c17ec4d4f_0.jpeg?X-Tos-Algorithm=TOS4-HMAC-SHA256&X-Tos-Credential=AKLTYWJkZTExNjA1ZDUyNDc3YzhjNTM5OGIyNjBhNDcyOTQ%2F20260425%2Fcn-beijing%2Ftos%2Frequest&X-Tos-Date=20260425T183531Z&X-Tos-Expires=86400&X-Tos-Signature=7b67cc331347a58a079c051ef6f6c8a10e159bfc01d09601d5c7df18e9dcee9d&X-Tos-SignedHeaders=host","size":"1024x1024"}],"usage":{"generated_images":1,"output_tokens":4096,"total_tokens":4096}}\n	{"guidance_scale":7,"image":""base64数据"","image_url":""base64数据"","model":"doubao-seedream-4-0-250828","prompt":"吧图一的上衣换到图二身上","ratio":"1:1","size":"1024x1024","watermark":false}	0	固定按次计费 -> (1量 * 0.2单价 * 1.00倍率) | 等级折扣	2026-04-25 18:35:31.254998+00	0		图片
71	a6fde4b2-5728-4fbb-b14c-de4934cb66da	4	13	gpt-image-2	0	0	0	383	200	/v1/images/generations	\N	https://api.apimart.ai/v1/images/generations	{"background":"auto","model":"gpt-image-2","n":1,"output_format":"png","prompt":"一个亚洲美女在咖啡店喝咖啡穿着包臀连衣裙吊带","quality":"auto","size":"1024x1024"}	{"code":200,"data":[{"status":"submitted","task_id":"task_01KQAKHZM80H6YZRPB24PVNE8Y"}]}	{"background":"auto","model":"gpt-image-2","n":1,"output_format":"png","prompt":"一个亚洲美女在咖啡店喝咖啡穿着包臀连衣裙吊带","quality":"auto","size":"1024x1024"}	0	异步任务处理中(冻结)	2026-04-28 17:52:55.843659+00	0		图片
64	a6fde4b2-5728-4fbb-b14c-de4934cb66da	0	0	gpt-image-2	0	0	0	0	404	/v1/images/generations	No available channels found for model gpt-image-2		\N	\N	\N	0		2026-04-28 17:42:54.218475+00	0		图片
62	a6fde4b2-5728-4fbb-b14c-de4934cb66da	0	0	gptimage2vip	0	0	0	0	404	/v1/images/generations	No available channels found for model gptimage2vip		\N	\N	\N	0		2026-04-28 17:38:17.091745+00	0		图片
63	a6fde4b2-5728-4fbb-b14c-de4934cb66da	0	0	gpt-image	0	0	0	0	404	/v1/images/generations	No available channels found for model gpt-image		\N	\N	\N	0		2026-04-28 17:38:20.903345+00	0		图片
65	a6fde4b2-5728-4fbb-b14c-de4934cb66da	0	0	gptimage2vip	0	0	0	0	404	/v1/images/generations	No available channels found for model gptimage2vip		\N	\N	\N	0		2026-04-28 17:42:59.05247+00	0		图片
61	a6fde4b2-5728-4fbb-b14c-de4934cb66da	4	13	gpt-image-2	0	0	0	99285	200	/v1/images/generations	\N	https://api.apimart.ai/v1/images/generations	{"background":"auto","model":"gpt-image-2","n":1,"output_format":"png","prompt":"一个亚洲美女穿着吊带包臀短裙在咖啡店喝咖啡","quality":"auto","size":"1024x1024"}	{"code":200,"data":{"actual_time":46,"completed":1777397939,"created":1777397893,"estimated_time":100,"id":"task_01KQAJQ28KF2CG7EAPZSM2139B","progress":100,"result":{"images":[{"expires_at":1777484339,"url":["https://upload.apimart.ai/f/image/9998222602062849-3c47f3b2-14cd-4efb-ab45-6233565c4604-gpt_image_2_backup_task_01KQAJRCZY3HSGNCAC66NPBYKJ_0.png","https://upload.apimart.ai/f/image/9998222602061892-2544a701-1a86-45a2-872b-e43bcfe5c73a-gpt_image_2_backup_task_01KQAJRCZY3HSGNCAC66NPBYKJ_1.png"]}]},"status":"completed"}}	{"background":"auto","model":"gpt-image-2","n":1,"output_format":"png","prompt":"一个亚洲美女穿着吊带包臀短裙在咖啡店喝咖啡","quality":"auto","size":"1024x1024"}	0	分辨率匹配计费(默认单价: 0) -> (2量 * 0.000000单价 * 1.00倍率) | 模型全站折扣 | [后台自动轮询结算]	2026-04-28 17:38:13.805308+00	0		图片
66	a6fde4b2-5728-4fbb-b14c-de4934cb66da	0	0	gpt-image	0	0	0	0	404	/v1/images/generations	No available channels found for model gpt-image		\N	\N	\N	0		2026-04-28 17:43:02.403906+00	0		图片
50	348e130f-1955-41ec-953a-c478a901738c	3	10	doubao-seedance-2-0-fast-260128	0	108900	4.0293	180001	200	/v1/video/generations	\N	https://ark.cn-beijing.volces.com/api/v3/contents/generations/tasks	\N	{"id":"cgt-20260428174157-h54cv","model":"doubao-seedance-2-0-fast-260128","status":"succeeded","content":{"video_url":"https://ark-acg-cn-beijing.tos-cn-beijing.volces.com/doubao-seedance-2-0-fast/02177736937447700000000000000000000ffffac1823a398f6bd.mp4?X-Tos-Algorithm=TOS4-HMAC-SHA256&X-Tos-Credential=AKLTYWJkZTExNjA1ZDUyNDc3YzhjNTM5OGIyNjBhNDcyOTQ%2F20260428%2Fcn-beijing%2Ftos%2Frequest&X-Tos-Date=20260428T094436Z&X-Tos-Expires=86400&X-Tos-Signature=3bb58d3a0c2f53d2d548896b562e4610a6dfd8ae500bbfd6b8256052653e17c2&X-Tos-SignedHeaders=host"},"usage":{"completion_tokens":108900,"total_tokens":108900},"created_at":1777369318,"updated_at":1777369492,"seed":37074,"resolution":"720p","ratio":"16:9","duration":5,"framespersecond":24,"service_tier":"default","execution_expires_after":172800,"generate_audio":true,"draft":false}\n	\N	0	Seedance2.0(720p|无视频|基本单价:37) -> (0P*37 + 108900C*37)/1M * 1.00倍率 | 等级折扣 | 模型映射: doubao-seedance-2-0-fast-260128 ➞ ep-20260423183947-rhw99	2026-04-28 09:41:58.343319+00	0		视频
57	464fdb02-5e2f-4979-89d1-77da502682f6	3	12	doubao-seedance-2-0-fast-260128	0	50638	1.873606	1270890	200	/v1/video/generations	\N	https://ark.cn-beijing.volces.com/api/v3/contents/generations/tasks	{"camera_fixed":false,"content":[{"text":"按照图一做一段模特拍照换装的广告视频，需要使用图 1 2 3 的所有服装","type":"text"},{"image_url":{"url":"https://s3.artsapi.com/chedev/1000090577/dsdsd/8ebb5536-808e-4c07-ac9c-28bfee1cbee3.jpg"},"type":"image_url"}],"duration":5,"generate_audio":true,"model":"doubao-seedance-2-0-fast-260128","ratio":"9:16","resolution":"480p","return_last_frame":true,"seed":-1,"watermark":true}	{"id":"cgt-20260428211302-44vs8","model":"doubao-seedance-2-0-fast-260128","status":"succeeded","content":{"video_url":"https://ark-acg-cn-beijing.tos-cn-beijing.volces.com/doubao-seedance-2-0-fast/02177738198324800000000000000000000ffffac190db1807ee6.mp4?X-Tos-Algorithm=TOS4-HMAC-SHA256&X-Tos-Credential=AKLTYWJkZTExNjA1ZDUyNDc3YzhjNTM5OGIyNjBhNDcyOTQ%2F20260428%2Fcn-beijing%2Ftos%2Frequest&X-Tos-Date=20260428T131532Z&X-Tos-Expires=86400&X-Tos-Signature=4d976a91124d407a8c883a80a8b71b339c4cbf7772f558c0e8810d7ebfa2e1da&X-Tos-SignedHeaders=host","last_frame_url":"https://ark-acg-cn-beijing.tos-cn-beijing.volces.com/doubao-seedance-2-0-fast/02177738198324800000000000000000000ffffac190db1807ee6_last-frame.png?X-Tos-Algorithm=TOS4-HMAC-SHA256&X-Tos-Credential=AKLTYWJkZTExNjA1ZDUyNDc3YzhjNTM5OGIyNjBhNDcyOTQ%2F20260428%2Fcn-beijing%2Ftos%2Frequest&X-Tos-Date=20260428T131532Z&X-Tos-Expires=86400&X-Tos-Signature=e15bc1496d32b465874662576a8ddb976da8311b7273a752440d32da9cf6b4f4&X-Tos-SignedHeaders=host"},"usage":{"completion_tokens":50638,"total_tokens":50638},"created_at":1777381983,"updated_at":1777382156,"seed":29796,"resolution":"480p","ratio":"9:16","duration":5,"framespersecond":24,"service_tier":"default","execution_expires_after":172800,"generate_audio":true,"draft":false}\n	{"content":[{"text":"按照图一做一段模特拍照换装的广告视频，需要使用图 1 2 3 的所有服装","type":"text"},{"image_url":{"url":"asset://asset-20260428182345-mr4jz"},"type":"image_url"}],"duration":5,"generate_audio":true,"model":"ep-20260423183947-rhw99","ratio":"9:16","resolution":"480p","return_last_frame":true,"seed":-1,"watermark":true}	0	Seedance2.0(480p|无视频|基本单价:37) -> (0P*37 + 50638C*37)/1M * 1.00倍率 | 等级折扣 | [后台自动轮询结算]	2026-04-28 13:13:03.634946+00	0		视频
58	464fdb02-5e2f-4979-89d1-77da502682f6	3	12	doubao-seedance-2-0-fast-260128	0	0	0	53588	400	/v1/video/generations	{"error":{"code":"InvalidParameter","message":"The parameter `content` specified in the request is not valid: role must be specified for image contents. Request id: 021777387775942d64c75fbaa5981adc97406384c96876525fc05","param":"content","type":"BadRequest"}}	https://ark.cn-beijing.volces.com/api/v3/contents/generations/tasks	{"camera_fixed":false,"content":[{"text":"按照图一做一段模特拍照换装的广告视频，需要使用图 1 2 3 的所有服装","type":"text"},{"image_url":{"url":"https://s3.artsapi.com/chedev/1000090577/dsdsd/3a314a60-76c7-4f19-a2f4-ae2cade2e1dc.jpg"},"type":"image_url"},{"image_url":{"url":"https://s3.artsapi.com/chedev/1000090577/dsdsd/78e5c88a-3b80-42e3-94c0-333af81e4a5e.jpg"},"type":"image_url"},{"image_url":{"url":"https://s3.artsapi.com/chedev/1000090577/dsdsd/8ebb5536-808e-4c07-ac9c-28bfee1cbee3.jpg"},"type":"image_url"}],"duration":5,"generate_audio":true,"model":"doubao-seedance-2-0-fast-260128","ratio":"9:16","resolution":"480p","return_last_frame":false,"seed":-1,"watermark":false}	{"error":{"code":"InvalidParameter","message":"The parameter `content` specified in the request is not valid: role must be specified for image contents. Request id: 021777387775942d64c75fbaa5981adc97406384c96876525fc05","param":"content","type":"BadRequest"}}	{"content":[{"text":"按照图一做一段模特拍照换装的广告视频，需要使用图 1 2 3 的所有服装","type":"text"},{"image_url":{"url":"asset://asset-20260428174153-lmbk8"},"type":"image_url"},{"image_url":{"url":"asset://asset-20260428224919-7x74q"},"type":"image_url"},{"image_url":{"url":"asset://asset-20260428182345-mr4jz"},"type":"image_url"}],"duration":5,"generate_audio":true,"model":"ep-20260423183947-rhw99","ratio":"9:16","resolution":"480p","return_last_frame":false,"seed":-1,"watermark":false}	0	素材转换: [Image] https://s3.artsapi.com/chedev/1000090577/dsdsd/3a314a60-76c7-4f19-a2f4-ae2cade2e... ✓ asset://asset-20260428174153-lmbk8 | [Image] https://s3.artsapi.com/chedev/1000090577/dsdsd/78e5c88a-3b80-42e3-94c0-333af81e4... ✓ asset://asset-20260428224919-7x74q | [Image] https://s3.artsapi.com/chedev/1000090577/dsdsd/8ebb5536-808e-4c07-ac9c-28bfee1cb... ✓ asset://asset-20260428182345-mr4jz	2026-04-28 14:49:36.318799+00	0		视频
\.
...
873	可灵 AI	4	1	\N	other	\N	2026-04-30 16:59:43.898212+00	2026-04-30 16:59:43.898212+00	1	\N
\.
...
16	doubao-seedance-2-0-fast-260128	doubao-seedance-2-0-fast-260128	1	1	null	1	\N	other	\N	0	[19]	18	0	2026-05-01 06:44:47.084+00	2026-05-01 06:44:47.084+00	301827	1	0	\N
...
24	57758684	464fdb02-5e2f-4979-89d1-77da502682f6	1000090577	video	1777386894_4e0f4b19.mp4	1267074	https://s3.artsapi.com/chedev/1000090577/57758684/videos/1777386894_4e0f4b19.mp4	chedev/1000090577/57758684/videos/1777386894_4e0f4b19.mp4		按照图一做一段模特拍照换装的广告视频，需要使用图 1 2 3 的所有服装	doubao-seedance-2-0-fast-260128	doubao-seedance-2-0-fast-260128	{"attached_url":"https://s3.artsapi.com/chedev/1000090577/dsdsd/8ebb5536-808e-4c07-ac9c-28bfee1cbee3.jpg","attached_urls":["https://s3.artsapi.com/chedev/1000090577/dsdsd/8ebb5536-808e-4c07-ac9c-28bfee1cbee3.jpg","https://s3.artsapi.com/chedev/1000090577/dsdsd/78e5c88a-3b80-42e3-94c0-333af81e4a5e.jpg","https://s3.artsapi.com/chedev/1000090577/dsdsd/3a314a60-76c7-4f19-a2f4-ae2cade2e1dc.jpg"],"created_at":"2026-04-28T13:12:42.088Z","id":"cgt-20260428211302-44vs8","model_id":"doubao-seedance-2-0-fast-260128","model_name":"doubao-seedance-2-0-fast-260128","prompt":"按照图一做一段模特拍照换装的广告视频，需要使用图 1 2 3 的所有服装","task_id":"cgt-20260428211302-44vs8"}	{"height":320,"width":480,"x":523.308,"y":386.686}	0	0	0	0	2026-04-28 14:34:57.889077+00
25	71656044	a6fde4b2-5728-4fbb-b14c-de4934cb66da	1006917716	image	1777400891_1a632002.jpeg	434556	https://s3.artsapi.com/chedev/1006917716/71656044/images/1777400891_1a632002.jpeg	chedev/1006917716/71656044/images/1777400891_1a632002.jpeg		一个亚洲美女在咖啡店喝咖啡穿着包臀连衣裙吊带	doubao-seedream-4-0-250828	doubao-seedream-4-0-250828	{"attached_url":"","attached_urls":[],"created_at":"2026-04-28T18:27:34.409Z","model_id":"doubao-seedream-4-0-250828","model_name":"doubao-seedream-4-0-250828","prompt":"一个亚洲美女在咖啡店喝咖啡穿着包臀连衣裙吊带"}	{"height":320,"width":480,"x":351.641,"y":387.203}	0	0	0	0	2026-04-28 18:28:25.727762+00
26	71656044	a6fde4b2-5728-4fbb-b14c-de4934cb66da	1006917716	image	1777403922_1f30ef7a.jpeg	378791	https://s3.artsapi.com/chedev/1006917716/71656044/images/1777403922_1f30ef7a.jpeg	chedev/1006917716/71656044/images/1777403922_1f30ef7a.jpeg		一个在躺在酒店穿着黑丝的美女	doubao-seedream-4-0-250828	doubao-seedream-4-0-250828	{"attached_url":"","attached_urls":[],"created_at":"2026-04-28T19:18:28.955Z","model_id":"doubao-seedream-4-0-250828","model_name":"doubao-seedream-4-0-250828","prompt":"一个在躺在酒店穿着黑丝的美女"}	{"height":320,"width":480,"x":459.507,"y":341.213}	0	0	0	0	2026-04-28 19:19:00.906522+00
\.
...
18310775	937afe47-9cd7-4ee8-9a22-fe4bd7720b34	1003645183	未命名项目			{"nodes":[],"transform":{"x":0,"y":0,"scale":1}}	0	2026-04-28 08:48:19.173436+00	2026-04-29 02:19:44.083777+00
...
57770809	464fdb02-5e2f-4979-89d1-77da502682f6	1000090577	未命名项目			{"nodes":[],"transform":{"x":0,"y":0,"scale":1}}	0	2026-04-28 13:20:37.294306+00	2026-04-28 13:49:54.287204+00
59494020	6b353326-4fd8-4d9b-a028-73b3f3c8da0d	1009210594	未命名项目			{}	0	2026-04-28 14:15:10.345461+00	2026-04-28 14:15:10.345461+00
71651053	a6fde4b2-5728-4fbb-b14c-de4934cb66da	1006917716	未命名项目			{"nodes":[],"transform":{"x":0,"y":0,"scale":1}}	0	2026-04-28 20:09:34.872959+00	2026-04-28 20:19:22.244308+00
71656044	a6fde4b2-5728-4fbb-b14c-de4934cb66da	1006917716	未23		https://s3.artsapi.com/chedev/1006917716/71656044/images/1777403922_1f30ef7a.jpeg	{"nodes":[{"id":"177739826244052fe","type":"image","status":"completed","x":628.843,"y":80.148,"width":480,"height":320,"zIndex":13,"taskData":{"prompt":"一个亚洲美女在咖啡店喝咖啡穿着包臀连衣裙吊带","model_name":"SC-gpt-image-2","model_id":"gpt-image-2","attached_urls":[],"created_at":"2026-04-28T17:44:22.440Z","attached_url":""},"resultData":{"data":[{"url":"https://s3.artsapi.com/chedev/1006917716/71656044/images/1777400891_1a632002.jpeg"}]}},{"id":"17774008544095o1x","type":"image","status":"completed","x":393.641,"y":254.203,"width":257,"height":207,"zIndex":11,"taskData":{"prompt":"一个亚洲美女在咖啡店喝咖啡穿着包臀连衣裙吊带","model_name":"doubao-seedream-4-0-250828","model_id":"doubao-seedream-4-0-250828","attached_urls":[],"created_at":"2026-04-28T18:27:34.409Z","attached_url":""},"resultData":{"data":[{"url":"https://ark-content-generation-v2-cn-beijing.tos-cn-beijing.volces.com/doubao-seedream-4-0/0217774008587073b744fffeb88c418a31726ba8a0f731c37a141_0.jpeg?X-Tos-Algorithm=TOS4-HMAC-SHA256&X-Tos-Credential=AKLTYWJkZTExNjA1ZDUyNDc3YzhjNTM5OGIyNjBhNDcyOTQ%2F20260428%2Fcn-beijing%2Ftos%2Frequest&X-Tos-Date=20260428T182745Z&X-Tos-Expires=86400&X-Tos-Signature=f8cd7e29951188aac263b4449e79299c197848893643f9ece647935b37093886&X-Tos-SignedHeaders=host"}]}},{"id":"1777403908954ce7f","type":"image","status":"completed","x":459.507,"y":341.213,"width":480,"height":320,"zIndex":12,"taskData":{"prompt":"一个在躺在酒店穿着黑丝的美女","model_name":"doubao-seedream-4-0-250828","model_id":"doubao-seedream-4-0-250828","attached_urls":[],"created_at":"2026-04-28T19:18:28.955Z","attached_url":""},"resultData":{"data":[{"url":"https://ark-content-generation-v2-cn-beijing.tos-cn-beijing.volces.com/doubao-seedream-4-0/0217774039131995630b2fa661ac131412e72f6bdd3759fe78d7b_0.jpeg?X-Tos-Algorithm=TOS4-HMAC-SHA256&X-Tos-Credential=AKLTYWJkZTExNjA1ZDUyNDc3YzhjNTM5OGIyNjBhNDcyOTQ%2F20260428%2Fcn-beijing%2Ftos%2Frequest&X-Tos-Date=20260428T191838Z&X-Tos-Expires=86400&X-Tos-Signature=2f6d822d776d15aa1bb6dc253690cffb7b5864f1c4c2cf4ad7b013bc561ec9d9&X-Tos-SignedHeaders=host"}]}}],"transform":{"x":0,"y":0,"scale":1}}	0	2026-04-28 16:41:44.658094+00	2026-04-28 23:39:54.186593+00
1	937afe47-9cd7-4ee8-9a22-fe4bd7720b34	1003645183	未命名项目			{"nodes":[{"id":"1777104890745","type":"video","status":"completed","x":378.901,"y":481.408,"width":480,"height":320,"zIndex":14,"taskData":{"prompt":"一个美女在咖啡店喝咖啡"},"resultData":null},{"id":"1777105046327","type":"image","status":"completed","x":460.501,"y":102.562,"width":480,"height":320,"zIndex":16,"taskData":{"prompt":"一个美女在咖啡店喝咖啡"},"resultData":{"data":[{"url":"https://ark-content-generation-v2-cn-beijing.tos-cn-beijing.volces.com/doubao-seedream-4-0/021777105048101ad6686bf264e1cfa8d614a02b293f5e0b62351_0.jpeg?X-Tos-Algorithm=TOS4-HMAC-SHA256&X-Tos-Credential=AKLTYWJkZTExNjA1ZDUyNDc3YzhjNTM5OGIyNjBhNDcyOTQ%2F20260425%2Fcn-beijing%2Ftos%2Frequest&X-Tos-Date=20260425T081735Z&X-Tos-Expires=86400&X-Tos-Signature=f97589bba2a23459ed3853c934d3cb9a95660caee33e4c8cc296ea935442a459&X-Tos-SignedHeaders=host"}]}},{"id":"1777105781550","type":"image","status":"error","x":525.265,"y":418.269,"width":480,"height":320,"zIndex":13,"taskData":{"prompt":"一个在咖啡店和咖啡的美女，穿着吊带上衣大波浪卷发的亚洲网红美女"},"resultData":{"message":"Upstream request failed"}}],"transform":{"x":0,"y":0,"scale":1}}	0	2026-04-25 07:48:38.080085+00	2026-04-29 02:08:51.181793+00
57758684	464fdb02-5e2f-4979-89d1-77da502682f6	1000090577	未命名项目		https://s3.artsapi.com/chedev/1000090577/57758684/videos/1777386894_4e0f4b19.mp4	{"nodes":[{"id":"177738196208831ez","type":"video","status":"completed","x":454.308,"y":143.686,"width":480,"height":718,"zIndex":15,"taskData":{"prompt":"按照图一做一段模特拍照换装的广告视频，需要使用图 1 2 3 的所有服装","model_name":"doubao-seedance-2-0-fast-260128","model_id":"doubao-seedance-2-0-fast-260128","attached_urls":["https://s3.artsapi.com/chedev/1000090577/dsdsd/8ebb5536-808e-4c07-ac9c-28bfee1cbee3.jpg","https://s3.artsapi.com/chedev/1000090577/dsdsd/78e5c88a-3b80-42e3-94c0-333af81e4a5e.jpg","https://s3.artsapi.com/chedev/1000090577/dsdsd/3a314a60-76c7-4f19-a2f4-ae2cade2e1dc.jpg"],"created_at":"2026-04-28T13:12:42.088Z","attached_url":"https://s3.artsapi.com/chedev/1000090577/dsdsd/8ebb5536-808e-4c07-ac9c-28bfee1cbee3.jpg","task_id":"cgt-20260428211302-44vs8","id":"cgt-20260428211302-44vs8"},"resultData":{"content":{"video_url":"https://ark-acg-cn-beijing.tos-cn-beijing.volces.com/doubao-seedance-2-0-fast/02177738198324800000000000000000000ffffac190db1807ee6.mp4?X-Tos-Algorithm=TOS4-HMAC-SHA256&X-Tos-Credential=AKLTYWJkZTExNjA1ZDUyNDc3YzhjNTM5OGIyNjBhNDcyOTQ%2F20260428%2Fcn-beijing%2Ftos%2Frequest&X-Tos-Date=20260428T131532Z&X-Tos-Expires=86400&X-Tos-Signature=4d976a91124d407a8c883a80a8b71b339c4cbf7772f558c0e8810d7ebfa2e1da&X-Tos-SignedHeaders=host"}}},{"id":"1777388288860ue44","type":"video","status":"completed","x":682.65,"y":308.039,"width":480,"height":790,"zIndex":17,"taskData":{"prompt":"按照图一做一段模特拍照换装的广告视频，需要使用图 1 2 3 的所有服装","model_name":"doubao-seedance-2-0-fast-260128","model_id":"doubao-seedance-2-0-fast-260128","attached_urls":["https://s3.artsapi.com/chedev/1000090577/dsdsd/3a314a60-76c7-4f19-a2f4-ae2cade2e1dc.jpg","https://s3.artsapi.com/chedev/1000090577/dsdsd/78e5c88a-3b80-42e3-94c0-333af81e4a5e.jpg","https://s3.artsapi.com/chedev/1000090577/dsdsd/8ebb5536-808e-4c07-ac9c-28bfee1cbee3.jpg"],"created_at":"2026-04-28T14:58:08.860Z","attached_url":"https://s3.artsapi.com/chedev/1000090577/dsdsd/3a314a60-76c7-4f19-a2f4-ae2cade2e1dc.jpg","task_id":"cgt-20260428225817-dc9b9","id":"cgt-20260428225817-dc9b9"},"resultData":{"content":{"video_url":"https://ark-acg-cn-beijing.tos-cn-beijing.volces.com/doubao-seedance-2-0-fast/02177738829786200000000000000000000ffffac157b31130f34.mp4?X-Tos-Algorithm=TOS4-HMAC-SHA256&X-Tos-Credential=AKLTYWJkZTExNjA1ZDUyNDc3YzhjNTM5OGIyNjBhNDcyOTQ%2F20260428%2Fcn-beijing%2Ftos%2Frequest&X-Tos-Date=20260428T150009Z&X-Tos-Expires=86400&X-Tos-Signature=eed8029cfd385328f4b8de08ac44b1445f079e4e6b37d57fc7d3be7ca7353bf8&X-Tos-SignedHeaders=host"}}},{"id":"1777390528902c2kr","type":"video","status":"completed","x":743.1,"y":425.174,"width":480,"height":320,"zIndex":18,"taskData":{"prompt":"把这个图片上的这个蓝色的衣服换到这个图 1 的视频身上。","model_name":"doubao-seedance-2-0-fast-260128","model_id":"doubao-seedance-2-0-fast-260128","attached_urls":["https://s3.artsapi.com/chedev/1000090577/57758684/references/1777390529_12e73d38.mp4","https://s3.artsapi.com/chedev/1000090577/57758684/references/1777390529_10e629ca.jpg"],"created_at":"2026-04-28T15:35:28.902Z","attached_url":"https://s3.artsapi.com/chedev/1000090577/57758684/references/1777390529_12e73d38.mp4","task_id":"cgt-20260428233643-jk4pb","id":"cgt-20260428233643-jk4pb"},"resultData":{"content":{"video_url":"https://ark-acg-cn-beijing.tos-cn-beijing.volces.com/doubao-seedance-2-0-fast/02177739068497100000000000000000000ffffac1778ad36053f.mp4?X-Tos-Algorithm=TOS4-HMAC-SHA256&X-Tos-Credential=AKLTYWJkZTExNjA1ZDUyNDc3YzhjNTM5OGIyNjBhNDcyOTQ%2F20260428%2Fcn-beijing%2Ftos%2Frequest&X-Tos-Date=20260428T153934Z&X-Tos-Expires=86400&X-Tos-Signature=b51ed4fc0ab8df726fe4983a8c3eb8c098ab20493dc5512de89a3455ac898343&X-Tos-SignedHeaders=host","last_frame_url":"https://ark-acg-cn-beijing.tos-cn-beijing.volces.com/doubao-seedance-2-0-fast/02177739068497100000000000000000000ffffac1778ad36053f_last-frame.png?X-Tos-Algorithm=TOS4-HMAC-SHA256&X-Tos-Credential=AKLTYWJkZTExNjA1ZDUyNDc3YzhjNTM5OGIyNjBhNDcyOTQ%2F20260428%2Fcn-beijing%2Ftos%2Frequest&X-Tos-Date=20260428T153934Z&X-Tos-Expires=86400&X-Tos-Signature=3fc4cdbac2e377bbfb28c45f2454181367d8710e21fbff2f5ac2f753d3a852a1&X-Tos-SignedHeaders=host"}}}],"transform":{"x":0,"y":0,"scale":1}}	0	2026-04-28 13:05:51.410186+00	2026-04-28 16:10:20.473356+00
71658758	a6fde4b2-5728-4fbb-b14c-de4934cb66da	1006917716	未23233333			{"nodes":[],"transform":{"x":0,"y":0,"scale":1}}	0	2026-04-28 17:06:15.079297+00	2026-04-28 20:09:24.817898+00
\.
...
11	464fdb02-5e2f-4979-89d1-77da502682f6	asset_manager	CreateAsset	{"GroupId":"group-20260428171227-xqt4n","URL":"https://s3.artsapi.com/chedev/1000090577/dsdsd/78e5c88a-3b80-42e3-94c0-333af81e4a5e.jpg","AssetType":"Image","ProjectName":"xinhankr_token"}	{"ResponseMetadata":{"RequestId":"2026042822491850C3E992AB6602E1B78A","Action":"CreateAsset","Version":"2024-01-01","Service":"ark","Region":"cn-beijing"},"Result":{"Id":"asset-20260428224919-7x74q"}}	200	2026-04-28 14:49:19.798211+00	relay_convert
12	464fdb02-5e2f-4979-89d1-77da502682f6	asset_manager	GetAsset	{"Id":"asset-20260428224919-7x74q","ProjectName":"xinhankr_token"}	{"ResponseMetadata":{"RequestId":"2026042822492250C3E992AB6602E1B816","Action":"GetAsset","Version":"2024-01-01","Service":"ark","Region":"cn-beijing"},"Result":{"Id":"asset-20260428224919-7x74q","Name":"","URL":"https://ark-media-asset.tos-cn-beijing.volces.com/2123777871/042822491803842457.jpg?X-Tos-Algorithm=TOS4-HMAC-SHA256\\u0026X-Tos-Credential=AKTP0VyX37NH37peqQWqz0vNrSRnRTc4HTc8D80znfh8d9%2F20260428%2Fcn-beijing%2Ftos%2Frequest\\u0026X-Tos-Date=20260428T144922Z\\u0026X-Tos-Expires=43200\\u0026X-Tos-Security-Token=nChBvMlNIdFphUGtMcUtHWld2.CiQKEHVNU1JGYmN4M1BjUm9iVlMSEMH3U7vW7UJRkXbg5ewaVvMQuNjAzwYY5KfDzwYg-v3I6QcoBDCs7-stOh9Sb2xlRm9yQXJrQXNzZXQvUm9sZUZvckFya0Fzc2V0QgNhcmtSD1JvbGVGb3JBcmtBc3NldFgDegNhcms._bW2LPt8jezAsm0yEQr-7JKkF6ZYc8RcgRIHdrYW7cKQZnYR_HHKDDfWkAh7jsu5_HnM45MhBKBa-ui7ivBMMw\\u0026X-Tos-Signature=c3e0e984159d5770e4b67d395b5f338a7dcf79c5ae6c2cac836dfbb1ace99eb3\\u0026X-Tos-SignedHeaders=host","AssetType":"Image","GroupId":"group-20260428171227-xqt4n","Status":"Active","CreateTime":"2026-04-28T14:49:19Z","UpdateTime":"2026-04-28T14:49:22Z","ProjectName":"xinhankr_token"}}	200	2026-04-28 14:49:23.056177+00	relay_convert
13	464fdb02-5e2f-4979-89d1-77da502682f6	asset_manager	CreateAsset	{"GroupId":"group-20260428171227-xqt4n","URL":"https://s3.artsapi.com/chedev/_tmp_asset_convert/10e629cabe53560c.jpg","AssetType":"Image","ProjectName":"xinhankr_token"}	{"ResponseMetadata":{"RequestId":"20260428233549AEA4AA960ACC24A2DAE7","Action":"CreateAsset","Version":"2024-01-01","Service":"ark","Region":"cn-beijing"},"Result":{"Id":"asset-20260428233550-5l5zz"}}	200	2026-04-28 15:35:50.675108+00	relay_convert
14	464fdb02-5e2f-4979-89d1-77da502682f6	asset_manager	GetAsset	{"Id":"asset-20260428233550-5l5zz","ProjectName":"xinhankr_token"}	{"ResponseMetadata":{"RequestId":"20260428233553AEA4AA960ACC24A2DB12","Action":"GetAsset","Version":"2024-01-01","Service":"ark","Region":"cn-beijing"},"Result":{"Id":"asset-20260428233550-5l5zz","Name":"","URL":"","AssetType":"Image","GroupId":"group-20260428171227-xqt4n","Status":"Processing","CreateTime":"2026-04-28T15:35:50Z","UpdateTime":"2026-04-28T15:35:52Z","ProjectName":"xinhankr_token"}}	200	2026-04-28 15:35:53.907476+00	relay_convert
15	464fdb02-5e2f-4979-89d1-77da502682f6	asset_manager	GetAsset	{"Id":"asset-20260428233550-5l5zz","ProjectName":"xinhankr_token"}	{"ResponseMetadata":{"RequestId":"20260428233556AEA4AA960ACC24A2DB3D","Action":"GetAsset","Version":"2024-01-01","Service":"ark","Region":"cn-beijing"},"Result":{"Id":"asset-20260428233550-5l5zz","Name":"","URL":"","AssetType":"Image","GroupId":"group-20260428171227-xqt4n","Status":"Processing","CreateTime":"2026-04-28T15:35:50Z","UpdateTime":"2026-04-28T15:35:52Z","ProjectName":"xinhankr_token"}}	200	2026-04-28 15:35:57.130364+00	relay_convert
16	464fdb02-5e2f-4979-89d1-77da502682f6	asset_manager	GetAsset	{"Id":"asset-20260428233550-5l5zz","ProjectName":"xinhankr_token"}	{"ResponseMetadata":{"RequestId":"20260428233600AEA4AA960ACC24A2DB64","Action":"GetAsset","Version":"2024-01-01","Service":"ark","Region":"cn-beijing"},"Result":{"Id":"asset-20260428233550-5l5zz","Name":"","URL":"https://ark-media-asset.tos-cn-beijing.volces.com/2123777871/042823354934207162.jpg?X-Tos-Algorithm=TOS4-HMAC-SHA256\\u0026X-Tos-Credential=AKTP0VyX37NH37peqQWqz0vNs8i14Z6w5wTmAehj9LNgsB%2F20260428%2Fcn-beijing%2Ftos%2Frequest\\u0026X-Tos-Date=20260428T153600Z\\u0026X-Tos-Expires=43200\\u0026X-Tos-Security-Token=nChBvMlNIdFphUGtMcUtHWld2.CiQKEHVNU1JGYmN4M1BjUm9iVlMSENhc1W1TL0lzoDSCZZFm9f8QxdvAzwYY46rDzwYg-v3I6QcoBDCs7-stOh9Sb2xlRm9yQXJrQXNzZXQvUm9sZUZvckFya0Fzc2V0QgNhcmtSD1JvbGVGb3JBcmtBc3NldFgDegNhcms.F3_7VQ0x1xzSWx4ZV6IMqwYyFaQ8ZQV77wFyxUQgvktgyksUcITSsRIi2fKjSk9ZNTS69Ot8OONXe0Z-JT5OYQ\\u0026X-Tos-Signature=04e6ee5916635e8db4209d7049155513e8cb6d3f3074acaa9b5d51657b70053a\\u0026X-Tos-SignedHeaders=host","AssetType":"Image","GroupId":"group-20260428171227-xqt4n","Status":"Active","CreateTime":"2026-04-28T15:35:50Z","UpdateTime":"2026-04-28T15:35:59Z","ProjectName":"xinhankr_token"}}	200	2026-04-28 15:36:00.356328+00	relay_convert
17	464fdb02-5e2f-4979-89d1-77da502682f6	asset_manager	CreateAsset	{"GroupId":"group-20260428171227-xqt4n","URL":"https://s3.artsapi.com/chedev/_tmp_asset_convert/12e73d38e6eaee04.mp4","AssetType":"Video","ProjectName":"xinhankr_token"}	{"ResponseMetadata":{"RequestId":"20260428233611AEA4AA960ACC24A2DBF1","Action":"CreateAsset","Version":"2024-01-01","Service":"ark","Region":"cn-beijing"},"Result":{"Id":"asset-20260428233612-cjjrv"}}	200	2026-04-28 15:36:12.988106+00	relay_convert
18	464fdb02-5e2f-4979-89d1-77da502682f6	asset_manager	GetAsset	{"Id":"asset-20260428233612-cjjrv","ProjectName":"xinhankr_token"}	{"ResponseMetadata":{"RequestId":"20260428233616AEA4AA960ACC24A2DC34","Action":"GetAsset","Version":"2024-01-01","Service":"ark","Region":"cn-beijing"},"Result":{"Id":"asset-20260428233612-cjjrv","Name":"","URL":"","AssetType":"Video","GroupId":"group-20260428171227-xqt4n","Status":"Processing","CreateTime":"2026-04-28T15:36:12Z","UpdateTime":"2026-04-28T15:36:14Z","ProjectName":"xinhankr_token"}}	200	2026-04-28 15:36:16.384828+00	relay_convert
19	464fdb02-5e2f-4979-89d1-77da502682f6	asset_manager	GetAsset	{"Id":"asset-20260428233612-cjjrv","ProjectName":"xinhankr_token"}	{"ResponseMetadata":{"RequestId":"20260428233619AEA4AA960ACC24A2DC5A","Action":"GetAsset","Version":"2024-01-01","Service":"ark","Region":"cn-beijing"},"Result":{"Id":"asset-20260428233612-cjjrv","Name":"","URL":"","AssetType":"Video","GroupId":"group-20260428171227-xqt4n","Status":"Processing","CreateTime":"2026-04-28T15:36:12Z","UpdateTime":"2026-04-28T15:36:14Z","ProjectName":"xinhankr_token"}}	200	2026-04-28 15:36:19.477447+00	relay_convert
20	464fdb02-5e2f-4979-89d1-77da502682f6	asset_manager	GetAsset	{"Id":"asset-20260428233612-cjjrv","ProjectName":"xinhankr_token"}	{"ResponseMetadata":{"RequestId":"20260428233622AEA4AA960ACC24A2DC8A","Action":"GetAsset","Version":"2024-01-01","Service":"ark","Region":"cn-beijing"},"Result":{"Id":"asset-20260428233612-cjjrv","Name":"","URL":"","AssetType":"Video","GroupId":"group-20260428171227-xqt4n","Status":"Processing","CreateTime":"2026-04-28T15:36:12Z","UpdateTime":"2026-04-28T15:36:14Z","ProjectName":"xinhankr_token"}}	200	2026-04-28 15:36:22.692491+00	relay_convert
21	464fdb02-5e2f-4979-89d1-77da502682f6	asset_manager	GetAsset	{"Id":"asset-20260428233612-cjjrv","ProjectName":"xinhankr_token"}	{"ResponseMetadata":{"RequestId":"20260428233625AEA4AA960ACC24A2DCCE","Action":"GetAsset","Version":"2024-01-01","Service":"ark","Region":"cn-beijing"},"Result":{"Id":"asset-20260428233612-cjjrv","Name":"","URL":"","AssetType":"Video","GroupId":"group-20260428171227-xqt4n","Status":"Processing","CreateTime":"2026-04-28T15:36:12Z","UpdateTime":"2026-04-28T15:36:14Z","ProjectName":"xinhankr_token"}}	200	2026-04-28 15:36:25.92511+00	relay_convert
22	464fdb02-5e2f-4979-89d1-77da502682f6	asset_manager	GetAsset	{"Id":"asset-20260428233612-cjjrv","ProjectName":"xinhankr_token"}	{"ResponseMetadata":{"RequestId":"20260428233628AEA4AA960ACC24A2DD03","Action":"GetAsset","Version":"2024-01-01","Service":"ark","Region":"cn-beijing"},"Result":{"Id":"asset-20260428233612-cjjrv","Name":"","URL":"","AssetType":"Video","GroupId":"group-20260428171227-xqt4n","Status":"Processing","CreateTime":"2026-04-28T15:36:12Z","UpdateTime":"2026-04-28T15:36:14Z","ProjectName":"xinhankr_token"}}	200	2026-04-28 15:36:29.160197+00	relay_convert
23	464fdb02-5e2f-4979-89d1-77da502682f6	asset_manager	GetAsset	{"Id":"asset-20260428233612-cjjrv","ProjectName":"xinhankr_token"}	{"ResponseMetadata":{"RequestId":"20260428233632AEA4AA960ACC24A2DD24","Action":"GetAsset","Version":"2024-01-01","Service":"ark","Region":"cn-beijing"},"Result":{"Id":"asset-20260428233612-cjjrv","Name":"","URL":"https://ark-media-asset.tos-cn-beijing.volces.com/2123777871/042823361195510268.mp4?X-Tos-Algorithm=TOS4-HMAC-SHA256\\u0026X-Tos-Credential=AKTP0VyX37NH37peqQWqz0vNrBO0JKdpkBjJwYmPSmraWr%2F20260428%2Fcn-beijing%2Ftos%2Frequest\\u0026X-Tos-Date=20260428T153632Z\\u0026X-Tos-Expires=43200\\u0026X-Tos-Security-Token=nChBvMlNIdFphUGtMcUtHWld2.CiQKEHVNU1JGYmN4M1BjUm9iVlMSELjssHN_n0vgoh7SylUIEZ0QtqfDzwYYnvjFzwYg-v3I6QcoBDCs7-stOh9Sb2xlRm9yQXJrQXNzZXQvUm9sZUZvckFya0Fzc2V0QgNhcmtSD1JvbGVGb3JBcmtBc3NldFgDegNhcms.GZL6Wgvuu0CoW0ejGZ2VzqLP_U2I23EmRz04wsUKMz3hEatA2mC63Uh-Sl2iWQSr6XfkzNhgSbpc_vEjFS9zdQ\\u0026X-Tos-Signature=20747ea72c3fa3b944abc9519f2c3054fec8d55bb4b3e60f671ba44d9ff55141\\u0026X-Tos-SignedHeaders=host","AssetType":"Video","GroupId":"group-20260428171227-xqt4n","Status":"Active","CreateTime":"2026-04-28T15:36:12Z","UpdateTime":"2026-04-28T15:36:31Z","ProjectName":"xinhankr_token"}}	200	2026-04-28 15:36:32.389952+00	relay_convert
24	a6fde4b2-5728-4fbb-b14c-de4934cb66da	asset_manager	CreateAssetGroup	{"Name":"Test Folder","Description":"This is a test description.","GroupType":"AIGC","ProjectName":"xinhankr_token"}	{"ResponseMetadata":{"RequestId":"20260429093022CC77B61F36E69389C6AE","Action":"CreateAssetGroup","Version":"2024-01-01","Service":"ark","Region":"cn-beijing"},"Result":{"Id":"group-20260429093022-wmj6x"}}	200	2026-04-29 01:30:23.474039+00	page
\.
...
15	a6fde4b2-5728-4fbb-b14c-de4934cb66da	group-20260429093022-wmj6x	Test Folder	This is a test description.	2026-04-29 01:30:24.278477+00	2026-04-29 01:30:24.278477+00
\.
...
18	464fdb02-5e2f-4979-89d1-77da502682f6	image	user	uploaded	0490020005873.jpg	https://s3.artsapi.com/chedev/1000090577/dsdsd/8ebb5536-808e-4c07-ac9c-28bfee1cbee3.jpg	image/jpeg	180125	\N	虚拟人像	\N	0	\N	group-20260428203150-hwlpk	2026-04-28 13:10:11.451075+00	2026-04-28 13:10:11.451075+00	\N
19	464fdb02-5e2f-4979-89d1-77da502682f6	image	user	uploaded	057003001663.jpg	https://s3.artsapi.com/chedev/1000090577/dsdsd/78e5c88a-3b80-42e3-94c0-333af81e4a5e.jpg	image/jpeg	115180	\N	虚拟人像	\N	0	\N	group-20260428203150-hwlpk	2026-04-28 13:10:16.134303+00	2026-04-28 13:10:16.134303+00	\N
20	464fdb02-5e2f-4979-89d1-77da502682f6	image	user	uploaded	051009003212.jpg	https://s3.artsapi.com/chedev/1000090577/dsdsd/3a314a60-76c7-4f19-a2f4-ae2cade2e1dc.jpg	image/jpeg	153391	\N	虚拟人像	\N	0	\N	group-20260428203150-hwlpk	2026-04-28 13:10:19.206187+00	2026-04-28 13:10:19.206187+00	\N
21	464fdb02-5e2f-4979-89d1-77da502682f6	image	relay_convert	approved	78e5c88a-3b80-42e3-94c0-333af81e4a5e.jpg	https://s3.artsapi.com/chedev/1000090577/dsdsd/78e5c88a-3b80-42e3-94c0-333af81e4a5e.jpg	\N	\N	\N	转换素材	asset-20260428224919-7x74q	0	\N	\N	2026-04-28 14:49:23.05619+00	2026-04-28 14:49:23.05619+00	39a6edf81e906cc4f5f3bf07f7f2e3dfb9daf1cf7570e1fab8b0d1d1898f94fc
22	464fdb02-5e2f-4979-89d1-77da502682f6	image	relay_convert	approved	10e629cabe53560c.jpg	https://s3.artsapi.com/chedev/_tmp_asset_convert/10e629cabe53560c.jpg	\N	\N	\N	转换素材	asset-20260428233550-5l5zz	0	\N	\N	2026-04-28 15:36:00.356332+00	2026-04-28 15:36:00.356332+00	10e629cabe53560c1827eedcd2d8c88fa1ddf1ffd03059608f415d32ac22c5fb
23	464fdb02-5e2f-4979-89d1-77da502682f6	video	relay_convert	approved	12e73d38e6eaee04.mp4	https://s3.artsapi.com/chedev/_tmp_asset_convert/12e73d38e6eaee04.mp4	\N	\N	\N	转换素材	asset-20260428233612-cjjrv	0	\N	\N	2026-04-28 15:36:32.390079+00	2026-04-28 15:36:32.390079+00	12e73d38e6eaee0452f836869f8bb2eda2de74954cd2dee462e651def7119860
\.
...
14	playground	pg_model_id_2	{"enabled":true,"scheme_id":"seedream_4_0"}	2026-04-25 08:12:45.889639+00	2026-04-28 17:47:00.545069+00
15	playground	pg_model_id_1	{"enabled":true,"scheme_id":"seedance1.5pro"}	2026-04-25 08:12:45.895533+00	2026-04-28 17:47:00.545913+00
...
63	playground	pg_model_id_15	{"enabled":false,"scheme_id":null}	2026-04-28 17:37:20.817667+00	2026-04-28 17:47:00.526653+00
64	playground	pg_model_id_14	{"enabled":false,"scheme_id":null}	2026-04-28 17:37:20.8266+00	2026-04-28 17:47:00.530138+00
65	playground	pg_model_id_13	{"enabled":false,"scheme_id":null}	2026-04-28 17:37:20.831589+00	2026-04-28 17:47:00.531752+00
66	playground	pg_model_id_12	{"enabled":false,"scheme_id":null}	2026-04-28 17:37:20.836025+00	2026-04-28 17:47:00.532991+00
67	playground	pg_model_id_11	{"enabled":true,"scheme_id":"gpt_image_2"}	2026-04-28 17:37:20.839957+00	2026-04-28 17:47:00.534753+00
55	playground	pg_model_id_10	{"enabled":true,"scheme_id":"seedance2.0fast"}	2026-04-28 09:07:05.758801+00	2026-04-28 17:47:00.536075+00
56	playground	pg_model_id_9	{"enabled":true,"scheme_id":"seedance2.0"}	2026-04-28 09:07:05.76451+00	2026-04-28 17:47:00.537354+00
57	playground	pg_model_id_8	{"enabled":false,"scheme_id":"gpt_image_2"}	2026-04-28 09:07:05.772945+00	2026-04-28 17:47:00.538473+00
58	playground	pg_model_id_7	{"enabled":false,"scheme_id":"gpt_image_2"}	2026-04-28 09:07:05.778602+00	2026-04-28 17:47:00.539631+00
59	playground	pg_model_id_6	{"enabled":false,"scheme_id":null}	2026-04-28 09:07:05.78342+00	2026-04-28 17:47:00.540751+00
60	playground	pg_model_id_5	{"enabled":false,"scheme_id":null}	2026-04-28 09:07:05.785781+00	2026-04-28 17:47:00.541719+00
61	playground	pg_model_id_4	{"enabled":false,"scheme_id":null}	2026-04-28 09:07:05.789367+00	2026-04-28 17:47:00.543177+00
62	playground	pg_model_id_3	{"enabled":false,"scheme_id":null}	2026-04-28 09:07:05.79155+00	2026-04-28 17:47:00.544243+00
...
19	a6fde4b2-5728-4fbb-b14c-de4934cb66da	16	registration	注册赠送	2026-04-28 16:38:35.913473+00
\.
...
COPY public.user_levels (id, name, group_key, discount, commission_ratio, invite_reward_inviter, invite_reward_invitee, daily_invite_limit, marketing_enabled, max_token_count, description, created_at, updated_at, is_default, allow_view_log_details) FROM stdin;
1	默认用户	default	1	0	0	0	10	0	10	普通用户，无折扣	2026-04-24 11:17:00.245028+00	2026-04-24 11:17:00.245028+00	1	1
9	33	33	1	0	0	0	10	0	10		2026-04-25 04:27:18.911859+00	2026-04-25 04:27:18.911859+00	0	1
10	33fsdf	333	1	0	0	0	10	0	10		2026-04-25 04:27:23.488964+00	2026-04-25 04:27:23.488964+00	0	1
12	4564654	5365416	1	0	0	0	10	0	10		2026-04-25 04:36:17.645215+00	2026-04-25 04:36:17.645215+00	0	1
14	高级 kol	gjkol	1	0	0	0	10	0	10		2026-04-25 07:15:31.104668+00	2026-04-25 07:15:31.104668+00	0	1
15	23132123	23132123	1	0	0	0	10	0	10		2026-04-25 07:15:46.125135+00	2026-04-25 07:15:46.125135+00	0	1
16	推广团队工作组	tgtdgzz	1	0	0	0	10	0	10		2026-04-25 07:32:02.924299+00	2026-04-25 07:32:02.924299+00	0	1
284	工作人员	gzry	1	0	0	0	10	0	10		2026-04-27 07:42:59.930575+00	2026-04-27 07:42:59.930575+00	0	1
\.
...
COPY public.users (id, uid, username, email, password_hash, nickname, mobile, wechat_id, role, balance, user_group, used_quota, is_active, remark, upstream_type, config, referred_by, commission_balance, admin_group_id, register_ip, admin_remark, created_at, updated_at, google_id, wechat_name, google_name, referral_history) FROM stdin;
...
464fdb02-5e2f-4979-89d1-77da502682f6	1000090577	wokankan2	u_85203302@tokensbyte.local	$argon2id$v=19$m=19456,t=2,p=1$wavAhZlHx5aoYJuyufb+MA$No/whngCd8r2Yn/qVpT49puf8QcfftlVkW4JbpIt0hc	\N	\N	\N	user	17.521042	default	7.478958	1	\N	other	\N	\N	0	\N	127.0.0.1		2026-04-28 11:55:31.438573+00	2026-04-28 15:39:51.939755+00	\N	\N	\N	
a6fde4b2-5728-4fbb-b14c-de4934cb66da	1006917716	ak23456	u_96640844@tokensbyte.local	$argon2id$v=19$m=19456,t=2,p=1$W7qRY6QonjOz/ZWd3A5p2w$iFWiEjuVI+/qvJAKvVbGTinNXhcARgpUNJ80w2ELjCE	\N	\N	\N	user	15.5	default	0.5	1	\N	other	\N	\N	0	\N	127.0.0.1		2026-04-28 16:38:35.913473+00	2026-04-28 19:18:38.825623+00	\N	\N	\N	
\.
...
1	1	active	images	0	0			100	0	0	0	0	0	2026-04-29	2026-04-29-03		0
1	2	active	images	0	0			100	0	0	0	0	0	2026-04-29	2026-04-29-03		0
1	8	active	images	0	0			100	0	0	0	0	0	2026-04-29	2026-04-29-03		0
\.
...
SELECT pg_catalog.setval('public.api_tokens_id_seq', 13, true);
...
SELECT pg_catalog.setval('public.billing_rules_id_seq', 19, true);
...
SELECT pg_catalog.setval('public.forward_rules_id_seq', 22, true);
...
SELECT pg_catalog.setval('public.logs_id_seq', 77, true);
...
SELECT pg_catalog.setval('public.model_providers_id_seq', 909, true);
...
SELECT pg_catalog.setval('public.model_types_id_seq', 1119, true);
...
SELECT pg_catalog.setval('public.playground_assets_id_seq', 26, true);
...
SELECT pg_catalog.setval('public.plugin_api_logs_id_seq', 24, true);
...
SELECT pg_catalog.setval('public.plugin_asset_groups_id_seq', 15, true);
...
SELECT pg_catalog.setval('public.plugin_assets_id_seq', 23, true);
...
SELECT pg_catalog.setval('public.plugin_configs_id_seq', 67, true);
...
SELECT pg_catalog.setval('public.plugins_id_seq', 1710, true);
...
SELECT pg_catalog.setval('public.recharge_records_id_seq', 19, true);
...
SELECT pg_catalog.setval('public.user_levels_id_seq', 460, true);
...
\unrestrict C19ePaVfaDtKHiyejELe4uTqh1zSSl6Ym6xT76KxunYZCzS80yZREecXfXn9Bs7

...
pub struct GptImagePool {
    pub id: i64,
    pub name: String,            // 卡池名称
    pub pool_type: String,       // image / custom
...
/// 卡池内的单个 GPT-Image 来源账号
#[derive(Debug, Clone, Serialize, Deserialize, FromRow)]
pub struct GptImagePoolAccount {
    pub id: i64,
...
pub struct CreateGptImagePoolRequest {
    pub name: String,
...
#[derive(Debug, Deserialize)]
pub struct UpdateGptImagePoolRequest {
...
#[derive(Debug, Deserialize)]
pub struct CreateGptImagePoolAccountRequest {
    pub name: String,
...
#[derive(Debug, Deserialize)]
pub struct UpdateGptImagePoolAccountRequest {
    pub name: Option<String>,
    pub base_url: Option<String>,
...
pub struct GptImagePoolAccountSafe {
    pub id: i64,
    pub name: String,
    pub base_url: String,
...
impl GptImagePoolAccount {
    /// 将 API Key 脱敏后返回安全版本
    pub fn to_safe(&self) -> GptImagePoolAccountSafe {
        let masked = {

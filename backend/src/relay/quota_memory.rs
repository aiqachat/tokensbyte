...
mod tests {
    ...
    #[test]
    fn micros_roundtrip() {
        assert!((from_micros(to_micros(1.234567)) - 1.234567).abs() < 1e-6);
        assert_eq!(to_micros(-1.0), 0);
    }

    #[test]
    fn invalidate_token_removes_matching_slots() {
        let guard = MemoryQuotaGuard::new();
        guard.slots.insert(
            "42:2026-07-19".into(),
            QuotaSlot {
                day: "2026-07-19".into(),
                week: "2026-28".into(),
                month: "2026-07".into(),
                daily_used: AtomicU64::new(100),
                weekly_used: AtomicU64::new(100),
                monthly_used: AtomicU64::new(100),
                total_used: AtomicU64::new(100),
                daily_limit: None,
                weekly_limit: None,
                monthly_limit: None,
                total_limit: None,
        ...
        guard.slots.insert(
            ...
            QuotaSlot {
                ...
                week: "2026-28".into(),
                month: "2026-07".into(),
                daily_used: AtomicU64::new(1),
                weekly_used: AtomicU64::new(1),
                monthly_used: AtomicU64::new(1),
                total_used: AtomicU64::new(1),
                daily_limit: None,
                weekly_limit: None,
                monthly_limit: None,
                total_limit: None,
        ...
        guard.invalidate_token(42);
        assert!(!guard.slots.contains_key("42:2026-07-19"));
        assert!(guard.slots.contains_key("43:2026-07-19"));
    }
}

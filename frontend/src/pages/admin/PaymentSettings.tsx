...
import { Card, Form, Input, Button, message, Typography, Tabs, Switch, Alert, Divider } from 'antd';
import { WechatOutlined, AlipayCircleOutlined, CopyOutlined, LinkOutlined, SafetyCertificateOutlined } from '@ant-design/icons';
